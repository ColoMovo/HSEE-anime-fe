...
import React161, {useCallback as useCallback118, useEffect as useEffect69, useMemo as useMemo118, useRef as useRef37} from "react";
...
var TimelineWidthProvider = ({ children }) => {
  ...
  return jsx2(TimelineWidthContext.Provider, {
...
var redrawTimelineSliderFast = createRef();
var TimelineSlider = () => {
...
var TimelineZoomContext = ({ children }) => {
  ...
  return jsx4(TimelineZoomCtx.Provider, {
    value,
    children
  });
};
...
var KeybindingContextProvider = ({ children }) => {
  ...
  return jsx5(KeybindingContext.Provider, {
    value,
    children
  });
};
...
var HighestZIndexProvider = ({ children }) => {
  ...
  return jsx6(HighestZIndexContext.Provider, {
    value,
    children
  });
};
...
var EscapeHook = ({ onEscape }) => {
  ...
  useEffect4(() => {
    const escape = keybindings2.registerKeybinding({
      event: "keydown",
      key: "Escape",
      callback: onEscape,
...
var HigherZIndex = ({ children, onEscape, onOutsideClick }) => {
  ...
  return jsxs2(ZIndexContext.Provider, {
    value,
    children: [
      jsx7(EscapeHook, {
        onEscape
...
import {useContext as useContext11, useEffect as useEffect13} from "react";
...
var openFolderKey = (folderName, parentName) => {
...
var FolderContextProvider = ({ children }) => {
  ...
  return jsx8(FolderContext.Provider, {
    value,
    children
  });
};
...
var SidebarContextProvider = ({ children }) => {
  ...
  return jsx9(SidebarContext.Provider, {
    value,
    children
  });
};
...
var createFolderIfDoesNotExist = (items, availableFolders, folderItem, foldersExpanded) => {
  ...
  itemList.push({
    ...
    items: [],
    key: folderItem.name,
    expanded: foldersExpanded[openFolderKey(folderItem.name, folderItem.parent)] ?? false,
...
import {useCallback as useCallback12, useContext as useContext7, useMemo as useMemo18, useState as useState13} from "react";
...
import {useCallback as useCallback7, useEffect as useEffect8, useMemo as useMemo13, useRef as useRef7, useState as useState9} from "react";
...
import {useCallback as useCallback6, useEffect as useEffect7, useMemo as useMemo12, useRef as useRef6, useState as useState8} from "react";
...
import {useCallback as useCallback5, useEffect as useEffect6, useMemo as useMemo11, useRef as useRef5, useState as useState7} from "react";
...
var SubMenuComponent = ({
  ...
  const onOutsideClick = useCallback4((e) => {
  ...
  return jsx16(HigherZIndex, {
    onEscape: onQuitFullMenu,
    onOutsideClick,
    children: jsx16("div", {
      style: portalStyle,
      className: "css-reset",
      children: jsx16(MenuContent2, {
        onNextMenu: noop,
...
var MenuSubItem = ({
  ...
  const onPointerEnter = useCallback5(() => {
    onItemSelected(id);
    setHovered(true);
  }, [id, onItemSelected]);
  ...
  const onQuitSubmenu = useCallback5(() => {
    setSubMenuActivated(false);
  }, [setSubMenuActivated]);
  const portalStyle = useMemo11(() => {
  ...
  return jsx17("div", {
    ...
    children: jsxs3(Row, {
      ...
      children: [
        ...
        subMenu ? jsx17(CaretRight, {}) : null,
        keyHint && !areKeyboardShortcutsDisabled() ? jsx17("span", {
          style: keyHintCss,
          children: keyHint
        }) : null,
        portalStyle && subMenu ? ReactDOM.createPortal(jsx17(SubMenuComponent, {
...
var MenuContent2 = ({
  ...
  const isMobileLayout = useMobileLayout();
  const [subMenuActivated, setSubMenuActivated] = useState8(false);
  if (values[0].type === "divider") {
    throw new Error("first value cant be divide");
  }
  const [selectedItem, setSelectedItem] = useState8(typeof preselectIndex === "number" && preselectIndex >= 0 ? values[preselectIndex].id : null);
  const onEscape = useCallback6(() => {
    onHide();
  }, [onHide]);
  const onItemSelected = useCallback6((id) => {
    setSelectedItem(id);
  }, []);
  const onArrowUp = useCallback6(() => {
  ...
  const onArrowDown = useCallback6(() => {
    setSelectedItem((prevItem) => {
      const index = values.findIndex((val) => val.id === prevItem);
  ...
  const onArrowRight = useCallback6(() => {
    if (selectedItem === null) {
      return onNextMenu();
    }
    const item = values.find((i) => i.id === selectedItem);
  ...
  const containerWithHeight = useMemo12(() => {
    const containerStyles = { ...container4 };
    if (fixedHeight === null) {
  ...
  useEffect7(() => {
    const escapeBinding = keybindings2.registerKeybinding({
      event: "keydown",
      key: "Escape",
      callback: onEscape,
      commandCtrlKey: false,
    ...
    const rightBinding = keybindings2.registerKeybinding({
      event: "keydown",
      key: "ArrowRight",
      commandCtrlKey: false,
    ...
    const leftBinding = keybindings2.registerKeybinding({
      event: "keydown",
      commandCtrlKey: false,
      key: "ArrowLeft",
    ...
    const downBinding = keybindings2.registerKeybinding({
      event: "keydown",
      key: "ArrowDown",
      commandCtrlKey: false,
    ...
    const upBinding = keybindings2.registerKeybinding({
      event: "keydown",
      key: "ArrowUp",
      callback: onArrowUp,
      commandCtrlKey: false,
    ...
    const enterBinding = keybindings2.registerKeybinding({
      event: "keydown",
      key: "Enter",
      callback: onEnter,
      commandCtrlKey: false,
    ...
    const spaceBinding = keybindings2.registerKeybinding({
      event: "keyup",
      key: " ",
      callback: onEnter,
      commandCtrlKey: false,
  ...
  return jsx18("div", {
    ...
    children: values.map((item) => {
      if (item.type === "divider") {
        return jsx18(MenuDivider, {}, item.id);
      }
      const onClick = (id, e) => {
        item.onClick(id, e);
        if (item.subMenu) {
...
var ContextMenu = ({ children, values }) => {
  ...
  const [opened, setOpened] = useState9({ type: "not-open" });
  const { currentZIndex } = useZIndex();
  ...
  const spaceToBottom = useMemo13(() => {
    if (size && opened.type === "open") {
      return size.windowSize.height - opened.top;
    }
    return 0;
  }, [opened, size]);
  const spaceToTop = useMemo13(() => {
    if (size && opened.type === "open") {
      return opened.top;
    }
    return 0;
  }, [opened, size]);
  const portalStyle = useMemo13(() => {
  ...
  return jsxs4(Fragment2, {
    children: [
      ...
      portalStyle ? ReactDOM2.createPortal(jsx19("div", {
        style: fullScreenOverlay,
        children: jsx19("div", {
          style: outerPortal,
          className: "css-reset",
          children: jsx19(HigherZIndex, {
            onOutsideClick: onHide,
            onEscape: onHide,
            children: jsx19("div", {
              style: portalStyle,
              children: jsx19(MenuContent2, {
                onNextMenu: noop,
                onPreviousMenu: noop,
                values,
                onHide,
...
var notificationCenter = createRef2();
...
var NotificationCenter = () => {
  ...
  const onRemove = useCallback8((id) => {
    setNotifications((not) => {
      return not.filter((n) => n.id !== id);
    });
  }, []);
  const addNotification = useCallback8((notification2) => {
...
import React18, {useCallback as useCallback9, useEffect as useEffect10, useMemo as useMemo15, useRef as useRef8} from "react";
...
import React17, {createRef as createRef3, useImperativeHandle as useImperativeHandle3, useMemo as useMemo14, useState as useState11} from "react";
import {
jsx as jsx22
} from "react/jsx-runtime";
var RenderQueueContext = React17.createContext({
  jobs: []
});
var renderJobsRef = createRef3();
var RenderQueueContextProvider = ({ children }) => {
  const [jobs, setJobs] = useState11(window.remotion_initialRenderQueue ?? []);
  ...
  return jsx22(RenderQueueContext.Provider, {
    value,
    children
  });
};
...
var StudioServerConnectionCtx = React18.createContext({
  previewServerState: {
    type: "init"
  },
  subscribeToEvent: () => {
...
var PreviewServerConnection = ({ children, readOnlyStudio }) => {
  ...
  const context2 = useMemo15(() => {
    return {
      previewServerState: state,
      subscribeToEvent
    };
  }, [state, subscribeToEvent]);
  return jsx23(StudioServerConnectionCtx.Provider, {
    value: context2,
    children
  });
};
...
import {useCallback as useCallback10, useMemo as useMemo16, useState as useState12} from "react";
import {
jsx as jsx25
} from "react/jsx-runtime";
var InlineAction = ({ renderAction, onClick, disabled, title }) => {
  const { tabIndex } = useZIndex();
  const [hovered, setHovered] = useState12(false);
  const onPointerEnter = useCallback10(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback10(() => {
    setHovered(false);
  }, []);
...
var SidebarRenderButton = ({ composition, visible }) => {
  const { setSelectedModal } = useContext6(ModalsContext);
  const { setSidebarCollapsedState } = useContext6(SidebarContext);
  const isMobileLayout = useMobileLayout();
  ...
  const { props } = useContext6(Internals5.EditorPropsContext);
...
var CompositionSelectorItem = ({
  ...
  const onPointerEnter = useCallback12(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback12(() => {
    setHovered(false);
  }, []);
  ...
  const onClick = useCallback12((evt) => {
    evt.preventDefault();
    if (item.type === "composition") {
  ...
  const onKeyPress = useCallback12((evt) => {
    if (evt.key === "Enter") {
      onClick(evt);
    }
  }, [onClick]);
  const { setSelectedModal } = useContext7(ModalsContext);
  const contextMenu = useMemo18(() => {
    if (item.type === "composition") {
      return [
        {
          id: "duplicate",
    ...
    return jsxs5(Fragment3, {
      children: [
        jsxs5("button", {
          ...
          children: [
            item.expanded ? jsx27(ExpandedFolderIcon, {
              style: iconStyle,
              color: hovered || selected ? "white" : LIGHT_TEXT
            }) : jsx27(CollapsedFolderIcon, {
              color: hovered || selected ? "white" : LIGHT_TEXT,
              style: iconStyle
            }),
            jsx27(Spacing, {
        ...
        item.expanded ? item.items.map((childItem) => {
          return jsx27(CompositionSelectorItem, {
            currentComposition,
            selectComposition,
            item: childItem,
            tabIndex,
  ...
  return jsx27(ContextMenu, {
    ...
    children: jsx27(Row, {
      ...
      children: jsxs5("a", {
        ...
        children: [
          isCompositionStill(item.composition) ? jsx27(StillIcon, {
            color: hovered || selected ? "white" : LIGHT_TEXT,
            style: iconStyle
          }) : jsx27(FilmIcon, {
            color: hovered || selected ? "white" : LIGHT_TEXT,
          ...
          jsx27("div", {
            children: jsx27(SidebarRenderButton, {
              visible: hovered,
...
var CurrentComposition = () => {
  const video2 = Internals6.useVideo();
  if (!video2) {
    return jsx28("div", {
      style: container6
    });
        ...
        children: [
          ...
          jsxs6("div", {
            ...
            children: [
              ...
              "x",
              video2.height,
              isCompositionStill(video2) ? null : `, ${video2.fps} FPS`
            ]
          }),
          isCompositionStill(video2) ? jsx28("div", {
            style: subtitle,
            children: "Still"
          }) : jsxs6("div", {
            style: subtitle,
            children: [
              "Duration ",
              renderFrame(video2.durationInFrames, video2.fps)
            ]
          })
        ]
      })
...
var compositionSelectorRef = createRef4();
var CompositionSelector = () => {
  const { compositions, canvasContent, folders } = useContext8(Internals7.CompositionManager);
  const [foldersExpanded, setFoldersExpanded] = useState14(loadExpandedFolders("compositions"));
  const { tabIndex } = useZIndex();
  const selectComposition = useSelectComposition();
  const toggleFolder = useCallback13((folderName, parentName) => {
  ...
  return jsxs7("div", {
    style: container7,
    children: [
      showCurrentComposition ? jsx29(CurrentComposition, {}) : null,
      jsx29("div", {
        className: "__remotion-vertical-scrollbar",
        style: list,
        children: items.map((c) => {
          return jsx29(CompositionSelectorItem, {
            level: 0,
...
import {createRef as createRef5, useCallback as useCallback18, useImperativeHandle as useImperativeHandle5, useState as useState18} from "react";
...
var useAssetDragEvents = function({
  name,
  parentFolder,
  dropLocation,
  setDropLocation
  ...
  const onDragLeave = useCallback14(() => {
    dragDepthRef.current--;
    if (dragDepthRef.current === 0) {
...
import React23, {useCallback as useCallback15, useContext as useContext9, useMemo as useMemo21, useRef as useRef10, useState as useState15} from "react";
...
var ClipboardIcon = ({ color, ...props }) => jsx30("svg", {
  viewBox: "0 0 384 512",
  ...props,
  children: jsx30("path", {
    fill: color,
...
var AssetFolderItem = ({
  ...
  const openFolderTimerRef = useRef10(null);
  ...
  return jsxs8("div", {
    ...
    children: [
      ...
      item.expanded ? jsx32(AssetFolderTree, {
        item: item.items,
        name: item.name,
        level,
        parentFolder,
...
var AssetFolderTree = ({
  ...
  const combinedParents = useMemo21(() => {
    return [parentFolder, name].filter(NoReactInternals3.truthy).join("/");
  }, [name, parentFolder]);
  return jsxs8("div", {
    children: [
      item.folders.map((folder3) => {
        return jsx32(AssetFolderItem, {
          item: folder3,
          tabIndex,
          level: level + 1,
      ...
      item.files.map((file2) => {
        return jsx32(AssetSelectorItem, {
          item: file2,
          tabIndex,
          level,
          parentFolder: combinedParents
...
var AssetSelectorItem = ({ item, tabIndex, level, parentFolder }) => {
  const isMobileLayout = useMobileLayout();
  const [hovered, setHovered] = useState15(false);
  const { setSidebarCollapsedState } = useContext9(SidebarContext);
  const onPointerEnter = useCallback15(() => {
    setHovered(true);
  }, []);
  const { canvasContent, setCanvasContent } = useContext9(Internals8.CompositionManager);
  ...
  const renderFileExplorerAction = useCallback15((color) => {
    return jsx32(ExpandedFolderIcon, {
      style: revealIconStyle,
      color
    });
  }, []);
  const renderCopyAction = useCallback15((color) => {
    return jsx32(ClipboardIcon, {
      style: revealIconStyle,
      color
    });
  }, []);
  const revealInExplorer = React23.useCallback((e) => {
    e.stopPropagation();
    openInFileExplorer({
  ...
  const copyToClipboard2 = useCallback15((e) => {
    e.stopPropagation();
...
var AssetSelector = ({ readOnlyStudio }) => {
  const { tabIndex } = useZIndex();
  const { assetFoldersExpanded, setAssetFoldersExpanded } = useContext10(FolderContext);
  const [dropLocation, setDropLocation] = useState16(null);
  const { subscribeToEvent } = useContext10(StudioServerConnectionCtx);
  const connectionStatus = useContext10(StudioServerConnectionCtx).previewServerState.type;
  const shouldAllowUpload = connectionStatus === "connected" && !readOnlyStudio;
  const [{ publicFolderExists, staticFiles }, setState] = React24.useState(() => {
    return {
      staticFiles: getStaticFiles(),
      publicFolderExists: window.remotion_publicFolderExists
    };
  });
  const assetTree = useMemo22(() => {
  ...
  const onDragOver = useCallback16((e) => {
    e.preventDefault();
  }, []);
  const onDrop = useCallback16(async (e) => {
    try {
      e.preventDefault();
      e.stopPropagation();
  ...
  return jsx33("div", {
    ...
    children: staticFiles.length === 0 ? publicFolderExists ? jsx33("div", {
      style: emptyState,
      children: jsxs9("div", {
        style: label,
        children: [
      ...
      onDragEnter,
      onDragLeave,
      children: jsx33(AssetFolderTree, {
        item: assetTree,
        level: 0,
        parentFolder: null,
        name: null,
...
import {useCallback as useCallback17, useMemo as useMemo23, useState as useState17} from "react";
import {
jsx as jsx34
} from "react/jsx-runtime";
var tabsContainer = {
...
var ExplorerPanel = ({ readOnlyStudio }) => {
  const [panel, setPanel] = useState18(() => getSelectedPanel());
  const onCompositionsSelected = useCallback18(() => {
    setPanel("compositions");
    persistSelectedOptionsSidebarPanel("compositions");
  }, []);
  const onAssetsSelected = useCallback18(() => {
    setPanel("assets");
  ...
  return jsxs10("div", {
    ...
    children: [
      ...
      panel === "compositions" ? jsx35(CompositionSelector, {}) : jsx35(AssetSelector, {
        readOnlyStudio
      })
    ]
  });
...
// src/components/InitialCompositionLoader.tsx
var useSelectAsset = () => {
  const { setCanvasContent } = useContext11(Internals9.CompositionManager);
  const { setAssetFoldersExpanded } = useContext11(FolderContext);
  return (asset) => {
...
var useSelectComposition = () => {
  const { setCompositionFoldersExpanded } = useContext11(FolderContext);
  const { setCanvasContent } = useContext11(Internals9.CompositionManager);
  const isMobileLayout = useMobileLayout();
...
var InitialCompositionLoader2 = () => {
  const { compositions, canvasContent, setCanvasContent } = useContext11(Internals9.CompositionManager);
  const selectComposition = useSelectComposition();
  ...
  useEffect13(() => {
    const onchange = () => {
      ...
      if (newCanvas && newCanvas.type === "asset") {
        ...
        const exists = staticFiles.find((file2) => {
          return file2.name === newCanvas.asset;
        });
        if (exists) {
...
import {useCallback as useCallback82, useMemo as useMemo88, useState as useState53} from "react";

// src/helpers/use-menu-structure.tsx
import {useContext as useContext17, useMemo as useMemo34} from "react";
...
import {useContext as useContext15, useMemo as useMemo30} from "react";
...
import {useCallback as useCallback19, useEffect as useEffect14, useMemo as useMemo25, useRef as useRef11, useState as useState19} from "react";
...
var Combobox = ({ values, selectedId, style: customStyle, title: title2 }) => {
  const [hovered, setIsHovered] = useState19(false);
  const [opened, setOpened] = useState19(false);
  ...
  return jsxs11(Fragment5, {
    children: [
      ...
      portalStyle ? ReactDOM3.createPortal(jsx38("div", {
        style: fullScreenOverlay,
        children: jsx38("div", {
          style: outerPortal,
          className: "css-reset",
          children: jsx38(HigherZIndex, {
            onOutsideClick: onHide,
            onEscape: onHide,
            children: jsx38("div", {
              style: portalStyle,
              children: jsx38(MenuContent2, {
                onNextMenu: noop,
                onPreviousMenu: noop,
                values,
                onHide,
...
import {useContext as useContext14, useEffect as useEffect19, useMemo as useMemo29, useRef as useRef14} from "react";
...
var getAssetMetadata = async (canvasContent) => {
  ...
  if (file2.status !== 200) {
    throw new Error(`Expected status code 200 or 404 for file, got ${file2.status}`);
  }
  const size = file2.headers.get("content-length");
  if (!size) {
...
var FilePreview = ({ fileType, src, currentAsset, assetMetadata }) => {
  ...
  if (fileType === "json") {
    return jsx42(JSONViewer, {
      src
    });
  }
  if (fileType === "txt") {
    return jsx42(TextViewer, {
      src
    });
  }
  return jsxs13(Fragment6, {
    children: [
      jsx42("div", {
        style: msgStyle,
...
var RenderPreview = ({ path, assetMetadata }) => {
  ...
  const connectionStatus = useContext12(StudioServerConnectionCtx).previewServerState.type;
...
var StaticFilePreview = ({ currentAsset, assetMetadata }) => {
  ...
  const exists = staticFiles.find((file2) => file2.name === currentAsset);
  if (connectionStatus === "disconnected") {
    return jsx45("div", {
      style: errMsgStyle2,
      children: "Studio server disconnected"
...
var VideoPreview = ({ canvasSize, contentDimensions, canvasContent, assetMetadata }) => {
  ...
  if (contentDimensions === null) {
    return jsx46("div", {
      style: centeredContainer,
      children: jsx46(Spinner, {
        duration: 0.5,
        size: 24
      })
    });
  }
  return jsx46(CompWhenItHasDimensions, {
    contentDimensions,
    canvasSize,
    canvasContent,
    assetMetadata
...
var CompWhenItHasDimensions = ({ contentDimensions, canvasSize, canvasContent, assetMetadata }) => {
  const { size: previewSize } = useContext14(Internals10.PreviewSizeContext);
  const { centerX, centerY, yCorrection, xCorrection, scale } = useMemo29(() => {
    ...
    return PlayerInternals5.calculateCanvasTransformation({
      canvasSize,
  ...
  return jsx46("div", {
    style: outer,
    children: canvasContent.type === "asset" ? jsx46(StaticFilePreview, {
      assetMetadata,
      currentAsset: canvasContent.asset
    }) : canvasContent.type === "output" ? jsx46(RenderPreview, {
      path: canvasContent.path,
      assetMetadata
    }) : jsx46(PortalContainer, {
      contentDimensions,
      scale,
      xCorrection,
      yCorrection
...
var PortalContainer = ({ scale, xCorrection, yCorrection, contentDimensions }) => {
  const { checkerboard: checkerboard2 } = useContext14(CheckerboardContext);
  ...
  const portalContainer = useRef14(null);
  return jsx46("div", {
    ref: portalContainer,
    style: style2
  });
...
var SizeSelector = () => {
  const { size, setSize } = useContext15(Internals11.PreviewSizeContext);
  const { canvasContent } = useContext15(Internals11.CompositionManager);
  const style2 = useMemo30(() => {
    return {
      padding: CONTROL_BUTTON_PADDING
    };
  }, []);
  const zoomable = useMemo30(() => {
    if (!canvasContent) {
      return null;
    }
    if (canvasContent.type === "composition") {
  ...
  const items = useMemo30(() => {
    return getUniqueSizes(size).map((newSize) => {
      return {
        ...
        leftItem: String(size.size) === String(newSize.size) ? jsx47(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
...
import React35, {useCallback as useCallback20, useEffect as useEffect20, useMemo as useMemo31, useRef as useRef15, useState as useState24} from "react";
...
var InputDraggerForwardRefFn = ({
  ...
  const [inputFallback, setInputFallback] = useState24(false);
  ...
  const onKeyPress = useCallback20((e) => {
    if (e.key === "Enter") {
  ...
  if (inputFallback) {
    return jsx48(HigherZIndex, {
      onEscape,
      onOutsideClick: noop,
      children: jsx48(RemotionInput, {
        ref: fallbackRef,
        autoFocus: true,
        onKeyPress,
        onBlur,
...
var InputDragger = React35.forwardRef(InputDraggerForwardRefFn);
...
var timeValueRef = React36.createRef();
var TimeValue = () => {
  const frame = useCurrentFrame();
  const config = Internals12.useUnsafeVideoConfig();
  const isStill = useIsStill();
  const { seek } = PlayerInternals6.usePlayer();
  const keybindings2 = useKeybinding();
  const ref = useRef16(null);
  const onTextChange = useCallback21((newVal) => {
    seek(parseInt(newVal, 10));
  }, [seek]);
  const onValueChange = useCallback21((val) => {
    seek(val);
  }, [seek]);
  ...
  useEffect21(() => {
    const gKey = keybindings2.registerKeybinding({
      event: "keypress",
      key: "g",
      callback: () => {
        ref.current?.click();
...
var useTimelineInOutFramePosition = () => {
  ...
  const state = useContext16(TimelineInOutContext);
  if (!videoConfig) {
...
var useTimelineSetInOutFramePosition = () => {
  const { setInAndOutFrames } = useContext16(SetTimelineInOutContext);
...
var TimelineInOutPointToggle = () => {
  ...
  const onInMark = useCallback22((e) => {
    if (!videoConfig) {
      return null;
    }
    if (e?.shiftKey) {
  ...
  const clearInMark = useCallback22((e) => {
    if (!videoConfig) {
      return null;
    }
    e.preventDefault();
  ...
  const clearOutMark = useCallback22((e) => {
    if (!videoConfig) {
      return null;
    }
    e?.preventDefault();
  ...
  const onOutMark = useCallback22((e) => {
    if (!videoConfig) {
      return null;
    }
    if (e?.shiftKey) {
  ...
  useEffect22(() => {
    ...
    const iKey = keybindings2.registerKeybinding({
      event: "keypress",
      key: "i",
      callback: (e) => {
        onInMark(e);
    ...
    const oKey = keybindings2.registerKeybinding({
      event: "keypress",
      key: "o",
      callback: (e) => {
        onOutMark(e);
    ...
    const xKey = keybindings2.registerKeybinding({
      event: "keypress",
      key: "x",
      callback: () => {
        onInOutClear(confId);
  ...
  }, [confId, keybindings2, onInMark, onInOutClear, onOutMark]);
  ...
  return jsxs17(Fragment8, {
    children: [
      jsx51(ControlButton, {
        ...
        children: jsx51(TimelineInPointer, {
      ...
      jsx51(ControlButton, {
        ...
        disabled: !videoConfig || timelinePosition === videoConfig.durationInFrames - 1,
        children: jsx51(TimelineOutPointer, {
...
import {createRef as createRef7} from "react";
var canvasRef = createRef7();
...
var pickColor = () => {
  ...
  open.then((color) => {
    copyText(color.sRGBHex).then(() => {
      showNotification(jsxs19(Fragment9, {
        children: [
          jsx54(ColorDot, {
            color: color.sRGBHex
          }),
...
var useMenuStructure = (closeMenu, readOnlyStudio) => {
  ...
  const { checkerboard: checkerboard3, setCheckerboard } = useContext17(CheckerboardContext);
  const { editorZoomGestures, setEditorZoomGestures } = useContext17(EditorZoomGesturesContext);
  const { editorShowRulers, setEditorShowRulers } = useContext17(EditorShowRulersContext);
  const { editorShowGuides, setEditorShowGuides } = useContext17(EditorShowGuidesContext);
  const { size, setSize } = useContext17(Internals15.PreviewSizeContext);
  const { type } = useContext17(StudioServerConnectionCtx).previewServerState;
  const {
    setSidebarCollapsedState,
    sidebarCollapsedStateLeft,
    sidebarCollapsedStateRight
  } = useContext17(SidebarContext);
  const sizes = getUniqueSizes(size);
  const isFullscreenSupported = document.fullscreenEnabled || document.webkitFullscreenEnabled;
  const mobileLayout = useMobileLayout();
  const structure = useMemo34(() => {
    let struct = [
      {
        id: "remotion",
        label: jsx55(Row, {
        ...
        items: [
          {
            ...
            subMenu: {
              ...
              items: sizes.map((newSize) => ({
                ...
                label: getPreviewSizeLabel(newSize),
                leftItem: String(newSize.size) === String(size.size) ? jsx55(Checkmark, {}) : null,
                onClick: () => {
                  closeMenu();
                  setSize(() => newSize);
                },
          ...
          },
          {
            ...
            leftItem: editorZoomGestures ? jsx55(Checkmark, {}) : null,
            subMenu: null,
          ...
          },
          {
            ...
            type: "item",
            value: "show-ruler",
            leftItem: editorShowRulers ? jsx55(Checkmark, {}) : null,
            subMenu: null,
          ...
          },
          {
            ...
            type: "item",
            value: "show-guides",
            leftItem: editorShowGuides ? jsx55(Checkmark, {}) : null,
            subMenu: null,
              ...
              items: [
                {
                  ...
                  keyHint: null,
                  label: "Responsive",
                  leftItem: sidebarCollapsedStateLeft === "responsive" ? jsx55(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: "responsive",
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Expanded",
                  leftItem: sidebarCollapsedStateLeft === "expanded" ? jsx55(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Collapsed",
                  leftItem: sidebarCollapsedStateLeft === "collapsed" ? jsx55(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: "collapsed",
              ...
              items: [
                {
                  ...
                  keyHint: null,
                  label: "Expanded",
                  leftItem: sidebarCollapsedStateRight === "expanded" ? jsx55(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Collapsed",
                  leftItem: sidebarCollapsedStateRight === "collapsed" ? jsx55(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: null,
          ...
          },
          {
            ...
            type: "item",
            value: "checkerboard",
            leftItem: checkerboard3 ? jsx55(Checkmark, {}) : null,
            subMenu: null,
            quickSwitcherLabel: checkerboard3 ? "Disable Checkerboard Transparency" : "Enable Checkerboard Transparency"
          },
          {
...
var makeSearchResults = (actions2, setSelectedModal) => {
  const items = actions2.map((menu) => {
...
import {useCallback as useCallback23, useMemo as useMemo35, useRef as useRef17, useState as useState25} from "react";
...
var MenuItem = ({
  ...
  const size = PlayerInternals7.useElementSize(ref, {
    triggerOnWindowResize: true,
    shouldApplyCssTransforms: true
  });
  const { tabIndex, currentZIndex } = useZIndex();
  const containerStyle2 = useMemo35(() => {
    return {
      ...container13,
  ...
  const onPointerEnter = useCallback23(() => {
    onItemHovered(id);
    setHovered(true);
  }, [id, onItemHovered]);
  const onPointerLeave = useCallback23(() => {
    setHovered(false);
  }, []);
  ...
  const outerStyle = useMemo35(() => {
    return {
      ...outerPortal,
      top: (size?.top ?? 0) + (size?.height ?? 0)
    };
  }, [size]);
  return jsxs20(Fragment10, {
    children: [
      jsx56("button", {
        ref,
        role: "button",
      ...
      portalStyle ? ReactDOM4.createPortal(jsx56("div", {
        className: "css-reset",
        style: outerStyle,
        children: jsx56(HigherZIndex, {
          onEscape: onItemQuit,
          onOutsideClick: onItemQuit,
          children: jsx56("div", {
            style: portalStyle,
            children: jsx56(MenuContent2, {
...
import {useContext as useContext18, useEffect as useEffect23, useState as useState27} from "react";

// src/components/OpenEditorButton.tsx
import {useCallback as useCallback24, useMemo as useMemo36, useState as useState26} from "react";
import {
jsx as jsx57
} from "react/jsx-runtime";
var svgStyle = {
...
var OpenEditorButton = ({ type }) => {
  ...
  const openInEditorSvg = jsx57("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle,
    children: jsx57("path", {
      fill: svgFillColor,
...
var MenuBuildIndicator = () => {
  ...
  const ctx = useContext18(StudioServerConnectionCtx).previewServerState;
  ...
  return jsxs21("div", {
    ...
    children: [
      showButton ? jsx58(Spacing, {
        x: 2
      }) : null,
      isBuilding ? jsx58("div", {
        style: spinner,
        children: jsx58(Spinner, {
          duration: 0.5,
          size: spinnerSize
        })
      }) : jsx58("div", {
      ...
      showButton ? jsx58(OpenEditorButton, {
        type: "editor"
      }) : window.remotion_gitSource ? jsx58(OpenEditorButton, {
        type: "git"
      }) : null
    ]
  });
...
import {useCallback as useCallback80, useContext as useContext50, useEffect as useEffect52} from "react";

// src/components/TopPanel.tsx
import {useCallback as useCallback79, useContext as useContext49, useEffect as useEffect51, useMemo as useMemo86} from "react";
...
import {useContext as useContext26, useEffect as useEffect34, useMemo as useMemo47, useState as useState34} from "react";
import {Internals as Internals24} from "remotion";

// src/error-overlay/remotion-overlay/ErrorLoader.tsx
import {useEffect as useEffect29, useState as useState31} from "react";
...
// src/error-overlay/react-overlay/utils/parser.ts
var extractLocation = function(token) {
...
var extractSourceMapUrl = function(fileContents) {
...
import {useCallback as useCallback25, useEffect as useEffect25} from "react";

// src/components/Button.tsx
import {forwardRef as forwardRef3, useMemo as useMemo37} from "react";
import {
jsx as jsx59
} from "react/jsx-runtime";
var button = {
...
var ButtonRefForwardFunction = ({
  ...
  const combined = useMemo37(() => {
    return {
      ...button,
      ...style3 ?? {}
    };
  }, [style3]);
  const buttonContainer = useMemo37(() => {
    return {
      padding: 10,
...
var AskOnDiscord = ({ canHaveKeyboardShortcuts }) => {
  const openInBrowser = useCallback25(() => {
  ...
  return jsxs22(Button, {
    onClick: openInBrowser,
    children: [
      "Ask on Discord",
      " ",
      canHaveKeyboardShortcuts ? jsx60(ShortcutHint, {
        keyToPress: "d",
        cmdOrCtrl: true
      }) : null
    ]
...
import {useCallback as useCallback27, useMemo as useMemo38, useRef as useRef18, useState as useState29} from "react";
...
var ErrorMessage = ({ message }) => {
  ...
  const size2 = PlayerInternals8.useElementSize(ref, {
  ...
  return jsxs24("div", {
    ...
    children: [
      ...
      errorLines !== null && errorLines > maxLines ? jsx64("div", {
        style: moreLine,
        children: jsx64("button", {
          type: "button",
          onClick: toggle,
          style: moreButton,
          children: jsx64(CaretDown2, {
            invert: expanded
          })
        })
      }) : null
...
var ErrorTitle = ({ name, message, symbolicating, canHaveDismissButton }) => {
  return jsxs26("div", {
    ...
    children: [
      jsxs26("div", {
        ...
        children: [
          ...
          jsxs26("div", {
            style: row2,
            children: [
              symbolicating ? jsxs26(Fragment11, {
                children: [
                  jsx66(Symbolicating, {}),
                  jsx66("div", {
                    style: spacer
      ...
      didUnmountReactApp() ? null : canHaveDismissButton ? jsx66(DismissButton, {}) : null
    ]
  });
};

// src/error-overlay/remotion-overlay/HelpLink.tsx
import {useCallback as useCallback28, useEffect as useEffect26} from "react";
import {
jsx as jsx67,
jsxs as jsxs27
} from "react/jsx-runtime";
...
var HelpLink = ({ canHaveKeyboardShortcuts, link }) => {
  ...
  return jsxs27(Button, {
    ...
    children: [
      ...
      link.title,
      '"',
      canHaveKeyboardShortcuts ? jsx67(ShortcutHint, {
        keyToPress: "h",
        cmdOrCtrl: true
      }) : null
    ]
...
var OpenInEditor = ({ stack, canHaveKeyboardShortcuts }) => {
  ...
  const { registerKeybinding } = useKeybinding();
  const dispatchIfMounted = useCallback29((payload) => {
  ...
  return jsxs28(Button, {
    onClick: openInBrowser,
    disabled: state.type !== "idle",
    children: [
      label4,
      canHaveKeyboardShortcuts ? jsx68(ShortcutHint, {
        keyToPress: "o",
        cmdOrCtrl: true
      }) : null
    ]
...
import {useCallback as useCallback30, useEffect as useEffect28} from "react";
import {
jsx as jsx70,
jsxs as jsxs29
} from "react/jsx-runtime";
var SearchGithubIssues = ({ message, canHaveKeyboardShortcuts }) => {
  ...
  return jsxs29(Button, {
    onClick: openInBrowser,
    children: [
      "Search GitHub Issues",
      " ",
      canHaveKeyboardShortcuts ? jsx70(ShortcutHint, {
        keyToPress: "g",
        cmdOrCtrl: true
      }) : null
    ]
...
import {useCallback as useCallback31, useState as useState30} from "react";
...
var StackElement = ({ s, lineNumberWidth, isFirst, defaultFunctionName }) => {
  ...
  const toggleCodeFrame = useCallback31(() => {
    ...
    children: [
      jsxs31("div", {
        ...
        children: [
          ...
          s.originalScriptCode && s.originalScriptCode.length > 0 ? jsx72(Button, {
            onClick: toggleCodeFrame,
            children: showCodeFrame ? jsx72(CaretDown2, {
              invert: false
            }) : jsx72(CaretRight2, {})
          }) : null
        ]
      ...
      jsx72("div", {
        children: s.originalScriptCode && s.originalScriptCode.length > 0 && showCodeFrame ? jsx72(CodeFrame, {
          lineNumberWidth,
...
var ErrorDisplay = ({
  ...
  return jsxs32("div", {
    children: [
      ...
      display.stackFrames.length > 0 && window.remotion_editorName ? jsxs32(Fragment12, {
        children: [
          jsx73(OpenInEditor, {
            canHaveKeyboardShortcuts: keyboardShortcuts,
      ...
      calculateMetadata ? jsxs32(Fragment12, {
        children: [
          jsx73("br", {}),
          jsx73(Spacing, {
            y: 0.5
          }),
          jsx73(CalculateMetadataErrorExplainer, {})
        ]
      }) : null,
      jsx73("div", {
        style: stack,
...
import {useContext as useContext21, useMemo as useMemo43} from "react";
...
import {useContext as useContext19, useMemo as useMemo41} from "react";
...
var useStudioCanvasDimensions = ({
  ...
  const { size: previewSize } = useContext19(Internals18.PreviewSizeContext);
  const { centerX, centerY, scale } = useMemo41(() => {
    ...
    return PlayerInternals9.calculateCanvasTransformation({
      canvasSize,
      compositionHeight: contentDimensions.height,
      compositionWidth: contentDimensions.width,
      previewSize: previewSize.size
  ...
  const canvasPosition = useMemo41(() => {
    return {
      left: centerX - previewSize.translation.x,
      top: centerY - previewSize.translation.y,
...
import {memo, useCallback as useCallback32, useContext as useContext20, useMemo as useMemo42} from "react";
...
var GuideComp = ({ guide, canvasDimensions, scale }) => {
  ...
  const guideContentStyle = useMemo42(() => {
    return {
      position: "relative",
  ...
  const onMouseDown = useCallback32((e) => {
    e.preventDefault();
    if (e.button !== 0) {
      return;
    }
...
var EditorGuides = ({ canvasSize, contentDimensions, assetMetadata }) => {
  ...
  const { canvasContent } = useContext21(Internals19.CompositionManager);
  if (canvasContent === null || canvasContent.type !== "composition") {
    throw new Error("Expected to be in a composition");
  }
  const { guidesList } = useContext21(EditorShowGuidesContext);
  const guidesForThisComposition = useMemo43(() => {
  ...
  return jsx76(Fragment13, {
    children: guidesForThisComposition.map((guide) => {
      return jsx76(Guide_default, {
        guide,
        canvasDimensions,
        scale
      }, guide.id);
...
var drawLabel = ({
  ...
  if (orientation === "horizontal") {
    context2.fillText(label4, originDistance + 4, 16);
  } else {
...
var drawGradient = ({
  ...
  const grd = context2.createLinearGradient(startX, startY, endX, endY);
  ...
  context2.fillRect(startX, startY, endX - startX, endY - startY);
};
var drawGuide = ({
  selectedGuide,
  scale,
  ...
  context2.strokeStyle = SELECTED_GUIDE;
  ...
  if (orientation === "vertical" && selectedGuide.orientation === "horizontal") {
    context2.moveTo(0, originDistance);
    context2.lineTo(canvasWidth, originDistance);
    drawLabel({
      context: context2,
    ...
    context2.moveTo(originDistance, 0);
    context2.lineTo(originDistance, canvasHeight);
    drawLabel({
      context: context2,
      label: selectedGuide.position.toString(),
      originDistance,
...
var drawMarkingOnRulerCanvas = ({
  ...
  context2.strokeStyle = RULER_COLOR;
  context2.lineWidth = 1;
  context2.beginPath();
  points.forEach((point) => {
    ...
    for (let i = 1;i < 5; i++) {
      ...
      if (orientation === "horizontal") {
        context2.moveTo(originDistance + markingOffsetXY / 5, 0);
        context2.lineTo(originDistance + markingOffsetXY / 5, 4);
      } else {
        context2.moveTo(0, originDistance + markingOffsetXY / 5);
        context2.lineTo(4, originDistance + markingOffsetXY / 5);
      }
    }
    context2.stroke();
    context2.font = "10px Arial, Helvetica, sans-serif";
    context2.textAlign = "left";
    context2.fillStyle = RULER_COLOR;
    drawLabel({
      orientation,
      context: context2,
...
var Ruler = ({
  ...
  const {
    ...
    guidesList,
    setEditorShowGuides
  } = useContext22(EditorShowGuidesContext);
  ...
  const selectedOrHoveredGuide = useMemo44(() => {
  ...
  const changeCursor = useCallback33((e) => {
    e.preventDefault();
...
var EditorRulers = ({ contentDimensions, canvasSize, assetMetadata, containerRef }) => {
  ...
  const rulerMarkingGaps = useMemo45(() => {
  ...
  const horizontalRulerScaleRange = useMemo45(() => getRulerScaleRange({
    canvasLength: canvasPosition.width,
    scale,
    canvasSize
  }), [canvasPosition.width, canvasSize, scale]);
  const verticalRulerScaleRange = useMemo45(() => getRulerScaleRange({
  ...
  } = useMemo45(() => getRulerPoints({
    rulerScaleRange: horizontalRulerScaleRange,
    rulerMarkingGaps,
    scale
  }), [horizontalRulerScaleRange, rulerMarkingGaps, scale]);
  const { points: verticalRulerPoints, startMarking: verticalRulerStartMarking } = useMemo45(() => getRulerPoints({
  ...
  const onMouseMove = useCallback34((e) => {
...
var useIsRulerVisible = () => {
  const { canvasContent } = useContext24(Internals21.CompositionManager);
  const { editorShowRulers } = useContext24(EditorShowRulersContext);
...
var Canvas = ({ canvasContent, size: size2 }) => {
  const { setSize, size: previewSize } = useContext25(Internals22.PreviewSizeContext);
  const { editorZoomGestures } = useContext25(EditorZoomGesturesContext);
  const keybindings2 = useKeybinding();
  const config = Internals22.useUnsafeVideoConfig();
  const areRulersVisible = useIsRulerVisible();
  const { editorShowGuides } = useContext25(EditorShowGuidesContext);
  const [assetResolution, setAssetResolution] = useState33(null);
  const contentDimensions = useMemo46(() => {
  ...
  useEffect32(() => {
    const resetBinding = keybindings2.registerKeybinding({
      event: "keydown",
      key: "0",
      commandCtrlKey: false,
      callback: onReset,
    ...
    const zoomIn = keybindings2.registerKeybinding({
      event: "keydown",
      key: "+",
      commandCtrlKey: false,
      callback: onZoomIn,
    ...
    const zoomOut = keybindings2.registerKeybinding({
      event: "keydown",
      key: "-",
      commandCtrlKey: false,
      callback: onZoomOut,
  ...
  }, [keybindings2, onReset, onZoomIn, onZoomOut]);
  const fetchMetadata = useCallback35(async () => {
  ...
  return jsxs35(Fragment15, {
    children: [
      jsxs35("div", {
        ref: canvasRef,
        style: container17,
        children: [
          size2 ? jsx80(VideoPreview, {
            canvasContent,
            contentDimensions,
            canvasSize: size2,
            assetMetadata: assetResolution
          }) : null,
          isFit ? null : jsx80("div", {
            style: resetZoom,
            className: "css-reset",
            children: jsx80(ResetZoomButton, {
              onClick: onReset
            })
          }),
          editorShowGuides && canvasContent.type === "composition" && jsx80(EditorGuides_default, {
            canvasSize: size2,
            contentDimensions,
            assetMetadata: assetResolution
          })
      ...
      areRulersVisible && jsx80(EditorRulers, {
        contentDimensions,
        canvasSize: size2,
        assetMetadata: assetResolution,
...
var CanvasOrLoading = ({ size: size2 }) => {
  ...
  const [takesALongTime, setTakesALongTime] = useState34(false);
  const { setZoom } = useContext26(TimelineZoomCtx);
  const { canvasContent } = useContext26(Internals24.CompositionManager);
  useEffect34(() => {
    const timeout = setTimeout(() => {
  ...
  const content = jsxs36(Fragment16, {
    children: [
      jsx81(ZoomPersistor, {}),
      jsx81(Canvas, {
        size: size2,
  ...
  if (resolved.type === "error") {
    return jsx81(ErrorLoading, {
      error: resolved.error
    });
  }
  return jsxs36(Fragment16, {
    children: [
      jsx81(FramePersistor, {}),
      " ",
      content
    ]
  });
...
import {useCallback as useCallback36, useContext as useContext27, useEffect as useEffect35} from "react";
...
// src/components/CurrentCompositionSideEffects.tsx
var TitleUpdater = () => {
  const renderQueue = useContext27(RenderQueueContext);
  const { canvasContent } = useContext27(Internals25.CompositionManager);
...
var CurrentCompositionKeybindings = ({ readOnlyStudio }) => {
  const keybindings2 = useKeybinding();
  const video2 = Internals25.useVideo();
  const { type } = useContext27(StudioServerConnectionCtx).previewServerState;
  const openRenderModal = useCallback36(() => {
    if (!video2) {
      return;
    }
    if (readOnlyStudio) {
...
function MobilePanel({
  ...
  const { currentZIndex } = useZIndex();
  return ReactDOM5.createPortal(jsxs37("div", {
    style: container19,
    children: [
      jsx83("div", {
        style: buttonContainer,
        children: jsx83(CancelButton, {
          style: button2,
          onPress: onClose
        })
      }),
...
import {Internals as Internals26, getInputProps} from "remotion";
...
import {useCallback as useCallback37, useMemo as useMemo49, useState as useState35} from "react";
import {
jsx as jsx85
} from "react/jsx-runtime";
var container21 = {
...
var useZodIfPossible = () => {
  const context3 = useContext28(ZodContext);
...
var ZodProvider = ({ children }) => {
  ...
  const contextValue = useMemo50(() => {
    return {
      zod,
      zodTypes
    };
  }, [zod, zodTypes]);
  return jsx86(ZodContext.Provider, {
    value: contextValue,
    children
  });
};
...
import React60, {useCallback as useCallback38, useEffect as useEffect37, useMemo as useMemo52} from "react";
...
var ZodErrorMessages = ({ zodValidationResult, viewTab }) => {
  ...
  const style7 = useMemo51(() => {
    return viewTab === "json" ? jsonLabel : schemaLabel;
  }, [viewTab]);
  const code = useMemo51(() => {
    return {
      ...schemaLabel,
      fontFamily: "monospace"
    };
...
var RenderModalJSONPropsEditor = ({
  ...
  const onChange = useCallback38((e) => {
  ...
  useEffect37(() => {
    const save = keybindings2.registerKeybinding({
      event: "keydown",
      key: "s",
      commandCtrlKey: true,
  ...
  }, [keybindings2, onQuickSave, onSave]);
  ...
  return jsxs40("div", {
    ...
    children: [
      ...
      localValue.validJSON === false ? jsx88(ValidationMessage, {
        align: "flex-start",
        message: localValue.error,
        type: "error"
      }) : localValue.zodValidation.success === false ? jsx88(ZodErrorMessages, {
...
import {useCallback as useCallback58, useEffect as useEffect40, useMemo as useMemo69} from "react";
...
import React82, {useMemo as useMemo68, useState as useState43} from "react";
...
import {createContext as createContext15, useContext as useContext29, useMemo as useMemo53} from "react";
import {
jsx as jsx90
} from "react/jsx-runtime";
...
var Fieldset = ({ children, shouldPad }) => {
  const alreadyPadded = useContext29(AlreadyPaddedRightContext);
  const style8 = useMemo53(() => {
    if (shouldPad) {
      return {
  ...
  const content = jsx90("div", {
    style: style8,
    children
  });
  if (shouldPad) {
    return jsx90(AlreadyPaddedRightContext.Provider, {
      value: true,
      children: content
    });
  }
...
import {useCallback as useCallback42, useMemo as useMemo54, useState as useState37} from "react";
...
var SchemaLabel = ({
  ...
  const onClickablePointerEnter = useCallback42(() => {
    setClickableButtonHovered(true);
  }, []);
  const onClickablePointerLeave = useCallback42(() => {
    setClickableButtonHovered(false);
  }, []);
  const labelContent = jsxs42("span", {
    style: labelStyle4,
    children: [
  ...
  return jsxs42("div", {
    ...
    children: [
      ...
      jsx94(Flex, {}),
      isDefaultValue ? null : jsx94(SchemaResetButton, {
        onClick: onReset
      }),
      isDefaultValue ? null : showSaveButton ? jsx94(SchemaSaveButton, {
        onClick: onSave,
        disabled: disableSave
      }) : null,
      onRemove ? jsx94(InlineRemoveButton, {
        onClick: onRemove
      }) : null
    ]
  });
...
import {useCallback as useCallback43, useMemo as useMemo55, useState as useState38} from "react";
...
var SchemaArrayItemSeparationLine = ({ onChange, index, schema, isLast }) => {
  ...
  const dynamicAddButtonStyle = useMemo55(() => {
    return {
      display: "flex",
      justifyContent: "center",
  ...
  const onOuterMouseEnter = useCallback43(() => {
    setOuterHovered(true);
  }, []);
  const onOuterMouseLeave = useCallback43(() => {
    setOuterHovered(false);
  }, []);
  const onInnerMouseEnter = useCallback43(() => {
    setInnerHovered(true);
  }, []);
  const onInnerMouseLeave = useCallback43(() => {
...
import React70, {useMemo as useMemo61, useState as useState41} from "react";

// src/components/RenderModal/SchemaEditor/ZodArrayItemEditor.tsx
import {useCallback as useCallback44, useMemo as useMemo57} from "react";
import {
jsx as jsx98
} from "react/jsx-runtime";
var ZodArrayItemEditor = ({
  ...
  const newJsonPath = useMemo57(() => [...jsonPath, index], [index, jsonPath]);
  const onSave = useCallback44((updater) => {
    onSaveObject((oldV) => [
      ...oldV.slice(0, index),
      updater(oldV[index]),
      ...oldV.slice(index + 1)
...
import {useCallback as useCallback45, useEffect as useEffect38, useMemo as useMemo59, useRef as useRef22, useState as useState39} from "react";
...
var InfoBubble = ({ title: title3, children }) => {
  ...
  }, [layout20, opened, size2]);
  const style8 = useMemo59(() => {
    return {
      ...container22,
      userSelect: "none",
      color: "white",
    ...
    children: [
      jsx100("button", {
        ...
        children: jsx100("svg", {
          style: icon3,
          viewBox: "0 0 512 512",
          children: jsx100("path", {
            fill: hovered ? "white" : LIGHT_TEXT,
            d: "M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336c-13.3 0-24 10.7-24 24s10.7 24 24 24h80c13.3 0 24-10.7 24-24s-10.7-24-24-24h-8V248c0-13.3-10.7-24-24-24H216c-13.3 0-24 10.7-24 24s10.7 24 24 24h24v64H216zm40-144a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"
          })
        })
      }),
      portalStyle ? ReactDOM6.createPortal(jsx100("div", {
        style: outerPortal,
        className: "css-reset",
        children: jsx100(HigherZIndex, {
          onOutsideClick: onHide,
          onEscape: onHide,
          children: jsx100("div", {
            style: portalStyle,
            children: jsx100(InfoTooltip, {
              backgroundColor: INPUT_BACKGROUND,
              arrowDirection: layout20,
              children
            })
          })
        })
      ...
      jsx101(InfoBubble, {
        ...
        children: jsxs47("div", {
          ...
          children: [
            ...
            localValue.zodValidation.error.errors.map((error, index) => jsxs47("div", {
              style: stackTraceLabel,
              children: [
                "Type: ",
                error.code,
...
var useLocalState = ({
  ...
  const parentRevision = useContext30(RevisionContext).childResetRevision;
  const [resetRevision, setResetRevision] = useState40(0);
  const [localValue, setLocalValue] = useState40(() => {
    return {
      [parentRevision]: {
        value,
  ...
  const currentLocalValue = useMemo60(() => {
  ...
  const RevisionContextProvider = useCallback46(({ children }) => {
    return jsx102(RevisionContext.Provider, {
      value: contextValue,
      children
    });
  }, [contextValue]);
...
var ZodArrayEditor = ({
  ...
  const isDefaultValue = useMemo61(() => {
    return deepEqual(localValue.value, defaultValue);
  }, [defaultValue, localValue]);
  return jsxs48(Fieldset, {
    shouldPad: mayPad,
    ...
    children: [
      ...
      expanded ? jsx103(RevisionContextProvider, {
        children: jsxs48(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            localValue.value.map((child, i) => {
              return jsxs48(React70.Fragment, {
                children: [
                  jsx103(ZodArrayItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  jsx103(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
            ...
            value.length === 0 ? jsx103(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true
...
var Checkbox = ({ checked, onChange, disabled, name }) => {
  ...
  return jsxs49("div", {
    ...
    children: [
      ...
      jsx104("div", {
        style: box,
        children: checked ? jsx104(Checkmark, {}) : null
      })
    ]
  });
};
...
var ZodBooleanEditor = ({
  ...
  const onToggle = useCallback47((e) => {
    onChange(() => e.target.checked, false, false);
  }, [onChange]);
  const save = useCallback47(() => {
    onSave(() => value, false, false);
  }, [onSave, value]);
  return jsxs50(Fieldset, {
    shouldPad: mayPad,
    success: localValue.zodValidation.success,
    children: [
      jsx105(SchemaLabel, {
...
import {useCallback as useCallback48, useMemo as useMemo64} from "react";
...
var ZodColorEditor = ({
  ...
  const onTextChange = useCallback48((e) => {
  ...
  const onOpacityChange = useCallback48((newValue) => {
  ...
  const onOpacityValueChange = useCallback48((newValue) => {
    const newColor = colorWithNewOpacity(localValue.value, Math.round(Number(newValue) / 100 * 255), zodTypes);
    onValueChange(() => newColor, false, false);
  }, [localValue.value, onValueChange, zodTypes]);
  return jsxs51(Fieldset, {
    shouldPad: mayPad,
    success: localValue.zodValidation.success,
    children: [
      jsx107(SchemaLabel, {
        ...
        children: [
          jsxs51(Row, {
            ...
            children: [
              jsx107("div", {
                style: colorPicker,
                children: jsx107(RemInputTypeColor, {
                  type: "color",
                  style: {
                    height: 39
                  },
...
import {useCallback as useCallback50, useMemo as useMemo65} from "react";
import {
jsx as jsx110,
jsxs as jsxs53
} from "react/jsx-runtime";
var ZodDiscriminatedUnionEditor = ({
  ...
  const options = useMemo65(() => [...typedSchema.optionsMap.keys()], [typedSchema.optionsMap]);
  const {
    localValue,
    onChange: setLocalValue,
    reset
  ...
  const comboBoxValues = useMemo65(() => {
    return options.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value[typedSchema.discriminator] ? jsx110(Checkmark, {}) : null,
        onClick: () => {
  ...
  const save = useCallback50(() => {
    onSave(() => value, false, false);
  }, [onSave, value]);
  const discriminatedUnionReplacement = useMemo65(() => {
    return {
      discriminator: typedSchema.discriminator,
      markup: jsxs53(Fieldset, {
        shouldPad: mayPad,
        success: true,
        children: [
          jsx110(SchemaLabel, {
  ...
  return jsx110(ZodObjectEditor2, {
    jsonPath,
    mayPad,
    defaultValue,
    onRemove,
...
var ZodEffectEditor = ({
  ...
  return jsxs54(Fieldset, {
    shouldPad: mayPad,
    success: localValue.zodValidation.success,
    children: [
      jsx111("div", {
        style: fullWidth4,
        children: jsx111(ZodSwitch2, {
          value,
          setValue: onChange,
          jsonPath,
          schema: def.schema,
...
import {useCallback as useCallback51, useMemo as useMemo66} from "react";
import {
jsx as jsx112,
jsxs as jsxs55
} from "react/jsx-runtime";
...
var ZodEnumEditor = ({
  ...
  const comboBoxValues = useMemo66(() => {
    return def.values.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value ? jsx112(Checkmark, {}) : null,
        onClick: (id) => {
  ...
  return jsxs55(Fieldset, {
    ...
    children: [
      ...
      jsx112("div", {
        style: isRoot ? undefined : container23,
        children: jsx112(Combobox, {
          values: comboBoxValues,
          selectedId: value,
          title: value
        })
      }),
      jsx112(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
...
var ZodOrNullishEditor = ({
  ...
  const onCheckBoxChange = useCallback53((e) => {
  ...
  return jsxs57(Fieldset, {
    shouldPad: mayPad,
    success: localValue.zodValidation.success,
    children: [
      localValue.value === nullishValue ? jsx114(SchemaLabel, {
        handleClick: null,
        isDefaultValue: localValue.value === defaultValue,
        jsonPath,
        onReset: reset,
...
var ZodNullableEditor = ({
  ...
  const { innerType } = schema._def;
  return jsx115(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodOptionalEditor = ({
  ...
  const { innerType } = schema._def;
  return jsx117(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
import {useCallback as useCallback55, useMemo as useMemo67} from "react";
import {
jsx as jsx118,
jsxs as jsxs59
} from "react/jsx-runtime";
...
var ZodStaticFileEditor = ({
  ...
  const isRoot = jsonPath.length === 0;
  const comboBoxValues = useMemo67(() => {
    return getStaticFiles().map((option) => {
      return {
        ...
        id: option.src,
        keyHint: null,
        leftItem: option.src === value ? jsx118(Checkmark, {}) : null,
        onClick: (id) => {
          setLocalValue(() => id, false, false);
        },
        quickSwitcherLabel: null,
  ...
  return jsxs59(Fieldset, {
    ...
    children: [
      ...
      jsx118("div", {
        style: isRoot ? undefined : container24,
        children: jsx118(Combobox, {
          values: comboBoxValues,
          selectedId: localValue.value,
          title: value
        })
      }),
      jsx118(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
...
var ZodUnionEditor = ({
  ...
  if (options.length > 2) {
    return jsx121(ZonNonEditableValue, {
      jsonPath,
  ...
  return jsx121(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodSwitch2 = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return jsx122(ZodObjectEditor2, {
      setValue,
      value,
      defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return jsx122(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return jsx122(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return jsx122(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUndefined) {
    return jsx122(ZonNonEditableValue, {
      jsonPath,
      showSaveButton,
      label: "undefined",
      saving,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return jsx122(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return jsx122(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return jsx122(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return jsx122(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
...
var ZodObjectEditor2 = ({
  ...
  const keys = Object.keys(shape);
  const isRoot = jsonPath.length === 0;
  const isDefaultValue = useMemo68(() => {
    return deepEqual(localValue.value, defaultValue);
  }, [defaultValue, localValue]);
  const suffix2 = useMemo68(() => {
    return expanded ? " {" : " {...}";
  }, [expanded]);
  return jsxs62(Fieldset, {
    shouldPad: !isRoot && mayPad,
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : jsx123(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? jsx123(RevisionContextProvider, {
        children: jsx123(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return jsxs62(React82.Fragment, {
              children: [
                jsx123(ZodSwitch2, {
                  mayPad: true,
                ...
                i === keys.length - 1 ? null : jsx123(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : jsx123("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  const hasChanged = useMemo69(() => {
    return !deepEqual(defaultProps, value);
  }, [defaultProps, value]);
  useEffect40(() => {
    setUnsavedProps(hasChanged);
  }, [hasChanged]);
  const onQuickSave = useCallback58(() => {
  ...
  const def = schema._def;
  const typeName = def.typeName;
  const reset = useCallback58(() => {
    setValue(defaultProps);
  }, [defaultProps, setValue]);
  if (!zodValidationResult.success) {
    const defaultPropsValid = schema.safeParse(defaultProps);
    if (!defaultPropsValid.success) {
      return jsx124(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return jsx124(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return jsx124(TopLevelZodValue, {
  ...
  return jsx124("div", {
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: jsx124(ZodObjectEditor2, {
      discriminatedUnionReplacement: null,
      value,
      setValue,
      jsonPath: [],
...
var extractEnumJsonPaths = (schema, zodRuntime, currentPath) => {
  ...
  switch (typeName) {
    ...
    case zodRuntime.ZodFirstPartyTypeKind.ZodTuple: {
      return def.items.map((item2, i) => extractEnumJsonPaths(item2, zodRuntime, [...currentPath, i])).flat(1);
    }
    case zodRuntime.ZodFirstPartyTypeKind.ZodRecord: {
...
var WarningTriangle2 = (props) => {
  return jsx125("svg", {
    viewBox: "0 0 576 512",
    ...props,
    children: jsx125("path", {
      d: "M248.747 204.705l6.588 112c.373 6.343 5.626 11.295 11.979 11.295h41.37a12 12 0 0 0 11.979-11.295l6.588-112c.405-6.893-5.075-12.705-11.979-12.705h-54.547c-6.903 0-12.383 5.812-11.978 12.705zM330 384c0 23.196-18.804 42-42 42s-42-18.804-42-42 18.804-42 42-42 42 18.804 42 42zm-.423-360.015c-18.433-31.951-64.687-32.009-83.154 0L6.477 440.013C-11.945 471.946 11.118 512 48.054 512H527.94c36.865 0 60.035-39.993 41.577-71.987L329.577 23.985zM53.191 455.002L282.803 57.008c2.309-4.002 8.085-4.002 10.394 0l229.612 397.993c2.308 4-.579 8.998-5.197 8.998H58.388c-4.617.001-7.504-4.997-5.197-8.997z"
    })
  });
};
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  const onClick = useCallback59(() => {
    setShowWarning((s) => !s);
  }, [setShowWarning]);
  const buttonStyle3 = useMemo70(() => {
    return {
      ...style8,
  ...
  return jsxs63("button", {
    type: "button",
    style: buttonStyle3,
    onClick,
    children: [
      jsx125(WarningTriangle2, {
...
var DataEditor = ({
  ...
  const serializedJSON = useMemo71(() => {
    if (!inJSONEditor) {
      return null;
    }
  ...
  const zodValidationResult = useMemo71(() => {
    if (schema === "no-zod") {
      return "no-zod";
    }
    if (schema === "no-schema") {
  ...
  const canSaveDefaultProps = useMemo71(() => {
  ...
  const { fastRefreshes } = useContext31(Internals26.NonceContext);
  ...
  const { previewServerState, subscribeToEvent } = useContext31(StudioServerConnectionCtx);
  useEffect41(() => {
  ...
  if (schema === "no-zod") {
    return jsx126(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return jsx126(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  return jsxs64("div", {
    ...
    children: [
      jsxs64("div", {
        ...
        children: [
          jsxs64("div", {
            style: tabWrapper,
            children: [
              jsx126(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              jsx126(Flex, {}),
              warnings.length > 0 ? jsx126(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => jsxs64(React85.Fragment, {
            children: [
              jsx126(Spacing, {
                y: 1
              }),
              jsx126(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? jsx126(SchemaEditor, {
        value: defaultProps,
      ...
      }) : jsx126(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
import React95, {useContext as useContext37, useEffect as useEffect43, useMemo as useMemo78} from "react";
...
var RenderQueueCopyToClipboard = ({ job }) => {
  const renderCopyAction = useCallback61((color) => {
    return jsx127(ClipboardIcon, {
      style: revealIconStyle2,
      color
    });
  }, []);
  const onClick = useCallback61((e) => {
    e.stopPropagation();
    copyToClipboard({
      outName: job.outName,
...
import {useCallback as useCallback62, useContext as useContext32} from "react";
...
var RenderQueueError = ({ job }) => {
  const { setSelectedModal } = useContext32(ModalsContext);
  const { tabIndex } = useZIndex();
  const onClick = useCallback62(() => {
    setSelectedModal({
...
import {useCallback as useCallback63, useMemo as useMemo72} from "react";
import {
jsx as jsx129
} from "react/jsx-runtime";
var RenderQueueCancelButton = ({ job }) => {
  const onClick = useCallback63((e) => {
    e.stopPropagation();
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
  const icon4 = useMemo72(() => {
    return {
      height: 14,
      color: "currentColor"
    };
  }, []);
  const renderAction = useCallback63((color) => {
    return jsx129("svg", {
      style: icon4,
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 512 512",
      children: jsx129("path", {
        fill: color,
...
import React88, {useCallback as useCallback64, useContext as useContext33} from "react";
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  const [hovered, setHovered] = React88.useState(false);
  const onPointerEnter = useCallback64(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback64(() => {
    setHovered(false);
  }, []);
  ...
  if (job.status === "running") {
    return jsx131("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: jsx131(CircularProgress, {
...
import {useCallback as useCallback65, useMemo as useMemo73} from "react";
import {
jsx as jsx132
} from "react/jsx-runtime";
var RenderQueueOpenInFinderItem = ({ job }) => {
  const onClick = useCallback65((e) => {
    e.stopPropagation();
    openInFileExplorer({ directory: job.outName }).catch((err) => {
      showNotification(`Could not open file: ${err.message}`, 2000);
    });
  }, [job.outName]);
  const icon4 = useMemo73(() => {
    return {
      height: 12,
      color: "currentColor"
    };
  }, []);
  const renderAction = useCallback65((color) => {
    return jsx132(ExpandedFolderIconSolid, {
      style: icon4,
      color
    });
  }, [icon4]);
  return jsx132(InlineAction, {
    renderAction,
    onClick
  });
};
...
import {useCallback as useCallback66, useContext as useContext34} from "react";
import {
jsx as jsx134
} from "react/jsx-runtime";
var outputLocation2 = {
...
import {useCallback as useCallback67, useMemo as useMemo75} from "react";
import {
jsx as jsx135
} from "react/jsx-runtime";
var RenderQueueRemoveItem = ({ job }) => {
  ...
  const renderAction = useCallback67((color) => {
    return jsx135("svg", {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 320 512",
      children: jsx135("path", {
        fill: color,
        d: "M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z"
      })
    });
  }, [icon4]);
  return jsx135(InlineAction, {
    renderAction,
    onClick
  });
};
...
import {useCallback as useCallback68, useContext as useContext35, useMemo as useMemo76} from "react";
...
var RenderQueueRepeatItem = ({ job }) => {
  ...
  const isMobileLayout = useMobileLayout();
  const { setSidebarCollapsedState } = useContext35(SidebarContext);
...
var RenderQueueItem = ({ job, selected }) => {
  ...
  const { setCanvasContent } = useContext36(Internals27.CompositionManager);
  ...
  const containerStyle2 = useMemo77(() => {
    return {
      ...container26,
      backgroundColor: getBackgroundFromHoverState({
  ...
  const scrollCurrentIntoView = useCallback69(() => {
    ...
    children: [
      ...
      jsxs65("div", {
        ...
        children: [
          ...
          jsx137("div", {
            style: subtitle2,
            children: job.status === "done" ? jsx137(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? jsx137(RenderQueueError, {
              job
            }) : job.status === "running" ? jsx137(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? jsx137(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? jsx137(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? jsx137(RenderQueueCancelButton, {
        job
      }) : jsx137(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? jsx137(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
...
var RenderQueue = () => {
  ...
  const { canvasContent } = useContext37(Internals28.CompositionManager);
  ...
  return jsx138("div", {
    ...
    children: jobs.map((j, index) => {
      return jsx138("div", {
        ...
        children: jsx138(RenderQueueItem, {
...
import {useContext as useContext38, useMemo as useMemo79} from "react";
...
var RendersTab = ({ selected, onClick }) => {
  ...
  const { canvasContent } = useContext38(Internals29.CompositionManager);
  const failedJobs = jobs.filter((j) => j.status === "failed").length;
  const jobCount = jobs.length;
  const isActuallySelected = useMemo79(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return true;
    }
    return selected;
  }, [canvasContent, selected]);
  const badgeStyle = useMemo79(() => {
    return {
      ...badge,
...
var OptionsPanel = ({ readOnlyStudio }) => {
  const { props, updateProps } = useContext39(Internals30.EditorPropsContext);
  const [saving, setSaving] = useState46(false);
  const isMobileLayout = useMobileLayout();
  const container27 = useMemo80(() => ({
    height: "100%",
    width: "100%",
    display: "flex",
  ...
  const [panel, setPanel] = useState46(() => getSelectedPanel2(readOnlyStudio));
  const onPropsSelected = useCallback70(() => {
    setPanel("input-props");
    persistSelectedOptionsSidebarPanel2("input-props");
  }, []);
  const onRendersSelected = useCallback70(() => {
    setPanel("renders");
  ...
  const { compositions, canvasContent } = useContext39(Internals30.CompositionManager);
  const circleStyle = useMemo80(() => {
  ...
  const unsavedChangesExist = useMemo80(() => {
  ...
  return jsxs68("div", {
    ...
    children: [
      jsx140("div", {
        ...
        children: jsxs68(Tabs, {
          children: [
            composition ? jsxs68(Tab, {
              selected: panel === "input-props",
              onClick: onPropsSelected,
              style: { justifyContent: "space-between" },
              children: [
                "Props",
                unsavedChangesExist ? jsx140("div", {
                  title: saveToolTip,
                  style: circleStyle
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : jsx140(RendersTab, {
      ...
      panel === `input-props` && composition ? jsx140(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : readOnlyStudio ? null : jsx140(RenderQueue, {})
    ]
  });
};
...
import {useCallback as useCallback71, useContext as useContext40} from "react";
...
var CheckboardToggle = () => {
  const { checkerboard: checkerboard4, setCheckerboard } = useContext40(CheckerboardContext);
  const onClick = useCallback71(() => {
    setCheckerboard((c) => {
      return !c;
    });
  }, [setCheckerboard]);
  return jsx141(ControlButton, {
    ...
    children: jsx141("svg", {
      ...
      children: jsx141("path", {
        fill: checkerboard4 ? BLUE : "white",
...
var FpsCounter = ({ playbackSpeed }) => {
  const videoConfig = Internals31.useUnsafeVideoConfig();
  const [playing] = Internals31.Timeline.usePlayingState();
  const frame2 = Internals31.Timeline.useTimelinePosition();
...
import {useCallback as useCallback72, useContext as useContext41, useEffect as useEffect45} from "react";
...
var FullScreenToggle = () => {
  const keybindings2 = useKeybinding();
  const { setSize } = useContext41(Internals32.PreviewSizeContext);
  ...
  }, [keybindings2, onClick]);
  return jsx142(ControlButton, {
...
var LoopToggle = ({ loop: loop2, setLoop }) => {
  ...
  return jsx143(ControlButton, {
    ...
    children: jsx143("svg", {
      viewBox: "0 0 512 512",
      style: { width: 18, height: 18 },
      children: jsx143("path", {
        fill: loop2 ? BLUE : "white",
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return jsx145(ControlButton, {
    title: accessibilityLabel5,
    "aria-label": accessibilityLabel5,
    onClick,
    children: muted ? jsx145(VolumeOffIcon, {}) : jsx145(VolumeOnIcon, {})
  });
};

// src/components/PlayPause.tsx
import {PlayerInternals as PlayerInternals11} from "@remotion/player";
import {useCallback as useCallback75, useEffect as useEffect46, useState as useState48} from "react";
...
var PlayPause = ({ playbackRate, loop: loop2, bufferStateDelayInMilliseconds }) => {
  ...
  const {
    ...
    emitter
  } = PlayerInternals11.usePlayer();
  PlayerInternals11.usePlayback({
    loop: loop2,
    playbackRate,
  ...
  const onSpace = useCallback75((e) => {
    ...
    e.preventDefault();
  }, [pause2, play2, playing]);
  const onEnter = useCallback75((e) => {
    if (playing) {
      e.preventDefault();
      pauseAndReturnToPlayStart();
    }
  }, [pauseAndReturnToPlayStart, playing]);
  const onArrowLeft = useCallback75((e) => {
    e.preventDefault();
    if (e.altKey) {
      seek(0);
      ensureFrameIsInViewport({
  ...
  const onArrowRight = useCallback75((e) => {
    if (e.altKey) {
      ...
      ensureFrameIsInViewport({
        direction: "fit-right",
        durationInFrames: getCurrentDuration(),
        frame: Math.min(getCurrentDuration() - 1, getCurrentFrame() + getCurrentFps())
      });
    } else {
      frameForward(1);
      ensureFrameIsInViewport({
  ...
  const oneFrameBack = useCallback75(() => {
    frameBack(1);
  }, [frameBack]);
  const oneFrameForward = useCallback75(() => {
    frameForward(1);
  }, [frameForward]);
  const jumpToStart = useCallback75(() => {
    seek(inFrame ?? 0);
  }, [seek, inFrame]);
  const jumpToEnd = useCallback75(() => {
  ...
  useEffect46(() => {
    ...
    const arrowRight = keybindings2.registerKeybinding({
      event: "keydown",
      key: "ArrowRight",
      callback: onArrowRight,
      commandCtrlKey: false,
    ...
    const space = keybindings2.registerKeybinding({
      event: "keydown",
      key: " ",
      callback: onSpace,
      commandCtrlKey: false,
    ...
    const enter = keybindings2.registerKeybinding({
      event: "keydown",
      key: "enter",
      callback: onEnter,
      commandCtrlKey: false,
    ...
    const a = keybindings2.registerKeybinding({
      event: "keydown",
      key: "a",
    ...
    const e = keybindings2.registerKeybinding({
      event: "keydown",
      key: "e",
      callback: jumpToEnd,
      commandCtrlKey: false,
  ...
  return jsxs70(Fragment20, {
    children: [
      jsx151(ControlButton, {
        "aria-label": "Jump to beginning",
        title: "Jump to beginning",
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: jsx151(JumpToStart, {
          style: backStyle
        })
      }),
      jsx151(ControlButton, {
      ...
      jsx151(ControlButton, {
        ...
        onClick: playing ? pause2 : play2,
        disabled: !videoConfig,
        children: playing ? showBufferIndicator ? jsx151(PlayerInternals11.BufferingIndicator, {
          type: "studio"
        }) : jsx151(Pause, {
          style: iconButton
        }) : jsx151(Play, {
...
var PlaybackKeyboardShortcutsManager = ({ setPlaybackRate }) => {
  ...
  const onKKey = useCallback76(() => {
    setPlaybackRate(1);
    pause2();
  }, [pause2, setPlaybackRate]);
  const onLKey = useCallback76(() => {
    setPlaybackRate((prevPlaybackRate) => {
      if (!playing) {
        return 1;
      }
  ...
  useEffect47(() => {
    ...
    const kKey = keybindings2.registerKeybinding({
      event: "keydown",
      key: "k",
      callback: onKKey,
      commandCtrlKey: false,
    ...
    const lKey = keybindings2.registerKeybinding({
      event: "keydown",
      key: "l",
      callback: onLKey,
      commandCtrlKey: false,
  ...
  }, [keybindings2, onJKey, onKKey, onLKey]);
  return null;
};

// src/components/PlaybackRatePersistor.tsx
import {useContext as useContext42, useEffect as useEffect48} from "react";
...
var PlaybackRatePersistor = () => {
  const { setPlaybackRate, playbackRate } = useContext42(Internals34.Timeline.TimelineContext);
  useEffect48(() => {
...
import {useContext as useContext43, useMemo as useMemo82} from "react";
...
var PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
  const { canvasContent } = useContext43(Internals35.CompositionManager);
  const isStill = useIsStill();
  ...
  const items = useMemo82(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? jsx152(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
...
import {useCallback as useCallback77, useContext as useContext44, useMemo as useMemo83} from "react";
import {Internals as Internals36, useCurrentFrame as useCurrentFrame2} from "remotion";
import {
jsx as jsx153,
jsxs as jsxs71
} from "react/jsx-runtime";
...
var RenderButton = () => {
  ...
  const video2 = Internals36.useVideo();
  const frame2 = useCurrentFrame2();
  const { props } = useContext44(Internals36.EditorPropsContext);
  const onClick = useCallback77(() => {
    ...
    setSelectedModal({
      ...
      initialIgnoreCertificateErrors: defaults.ignoreCertificateErrors,
      initialOffthreadVideoCacheSizeInBytes: defaults.offthreadVideoCacheSizeInBytes,
      defaultProps: props[video2.id] ?? video2.defaultProps,
      inFrameMark: inFrame,
  ...
  }, [video2, setSelectedModal, frame2, props, inFrame, outFrame]);
  if (!video2) {
    return null;
  }
  return jsx153(Button, {
...
var TimelineZoomControls = () => {
  const { canvasContent } = useContext45(Internals37.CompositionManager);
...
var PreviewToolbar = ({ readOnlyStudio, bufferStateDelayInMilliseconds }) => {
  const { playbackRate, setPlaybackRate } = useContext46(Internals38.Timeline.TimelineContext);
  const { mediaMuted } = useContext46(Internals38.MediaVolumeContext);
  const { setMediaMuted } = useContext46(Internals38.SetMediaVolumeContext);
    ...
    children: [
      jsxs73("div", {
        ...
        children: [
          ...
          jsx156(TimelineZoomControls, {})
        ]
      }),
      jsx156(Flex, {}),
      jsx156(SizeSelector, {}),
      isStill || isVideoComposition ? jsx156(PlaybackRateSelector, {
        setPlaybackRate,
        playbackRate
      }) : null,
      isVideoComposition ? jsxs73(Fragment21, {
        children: [
          jsx156(Spacing, {
            x: 2
          }),
          ...
          jsx156(TimelineInOutPointToggle, {}),
          jsx156(Spacing, {
            x: 2
          }),
          jsx156(CheckboardToggle, {}),
          jsx156(Spacing, {
            x: 1
          })
        ]
      }) : null,
      isFullscreenSupported && jsx156(FullScreenToggle, {}),
      jsx156(Flex, {}),
      jsxs73("div", {
        style: sideContainer,
        children: [
          ...
          readOnlyStudio ? null : jsx156(RenderButton, {}),
          jsx156(Spacing, {
            x: 1.5
          })
        ]
      }),
      jsx156(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      jsx156(PlaybackRatePersistor, {})
    ]
  });
};

// src/components/Splitter/SplitterContainer.tsx
import {useEffect as useEffect49, useMemo as useMemo84, useRef as useRef26, useState as useState50} from "react";
...
var SplitterContext = React106.createContext({
  flexValue: 1,
  domRect: null,
  setFlexValue: () => {
    return;
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  const [flexValue, setFlexValue] = useState50(initialTimelineFlex ?? defaultFlex);
  const [domRect, setDomRect] = useState50(null);
  const ref = useRef26(null);
  const isDragging = useRef26(false);
  const [resizeObserver] = useState50(() => {
  ...
  return jsx157(SplitterContext.Provider, {
    value,
    children: jsx157("div", {
      ref,
...
import {useContext as useContext47, useMemo as useMemo85} from "react";
...
var SplitterElement = ({ children, type, sticky }) => {
  const context5 = useContext47(SplitterContext);
  const style9 = useMemo85(() => {
    return {
  ...
  }, [context5.flexValue, type]);
  const stickStyle = useMemo85(() => {
    return {
      position: "absolute",
      left: (type === "flexer" ? 0 : context5.flexValue) * 100 + "%",
      width: (type === "flexer" ? context5.flexValue : 1 - context5.flexValue) * 100 + "%",
      backgroundColor: interpolateColors(random(context5.flexValue), [0, 1], ["red", "blue"])
    };
  }, [context5.flexValue, type]);
  return jsxs74(Fragment22, {
    children: [
      jsx158("div", {
        style: style9,
        children
...
import {useContext as useContext48, useEffect as useEffect50, useRef as useRef27, useState as useState51} from "react";
import {
jsx as jsx159
} from "react/jsx-runtime";
...
var SplitterHandle = ({ allowToCollapse, onCollapse }) => {
  ...
  useEffect50(() => {
    ...
    const getNewValue = (e, clamp) => {
      ...
      const { width, height } = context5.domRect;
      const change = (() => {
        if (context5.orientation === "vertical") {
          return (e.clientX - context5.isDragging.current.x) / (width - SPLITTER_HANDLE_SIZE);
        }
        return (e.clientY - context5.isDragging.current.y) / (height - SPLITTER_HANDLE_SIZE);
      })();
      const newFlex = context5.flexValue + change;
      if (clamp) {
        return Math.min(context5.maxFlex, Math.max(context5.minFlex, newFlex));
      }
      return newFlex;
    };
    const onPointerDown = (e) => {
      ...
      window.addEventListener("pointerup", (ev) => {
        ...
        context5.persistFlex(getNewValue(ev, true));
        cleanup();
    ...
    const onPointerMove = (e) => {
      if (context5.isDragging.current) {
        ...
        if (allowToCollapse === "right") {
          ...
          if (unclamped < (1 - context5.maxFlex) / 2) {
            cleanup();
            onCollapse();
            setLastPointerUp(Date.now());
          }
    ...
    const cleanup = () => {
      context5.isDragging.current = false;
      ref.current?.classList.remove("remotion-splitter-active");
      current.removeEventListener("pointerdown", onPointerDown);
      window.removeEventListener("pointermove", onPointerMove);
      PlayerInternals13.updateAllElementsSizes();
    };
    current.addEventListener("pointerdown", onPointerDown);
    return () => {
      if (!context5.isDragging.current) {
  ...
  return jsx159("div", {
    ...
    className: [
      "remotion-splitter",
      context5.orientation === "horizontal" ? "remotion-splitter-horizontal" : "remotion-splitter-vertical"
    ].join(" "),
    style: context5.orientation === "horizontal" ? containerRow2 : containerColumn2
  });
};
...
var useResponsiveSidebarStatus = () => {
  const { sidebarCollapsedStateLeft } = useContext49(SidebarContext);
  const responsiveLeftStatus = useBreakpoint(1200) ? "collapsed" : "expanded";
  const actualStateLeft = useMemo86(() => {
...
var TopPanel = ({
  ...
  const { setSidebarCollapsedState, sidebarCollapsedStateRight } = useContext49(SidebarContext);
  const rulersAreVisible = useIsRulerVisible();
  const actualStateLeft = useResponsiveSidebarStatus();
  const actualStateRight = useMemo86(() => {
  ...
  return jsxs75("div", {
    ...
    children: [
      jsx160("div", {
        style: row4,
        children: jsxs75(SplitterContainer, {
          minFlex: 0.15,
          maxFlex: 0.4,
          defaultFlex: 0.2,
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? jsx160(MobilePanel, {
              onClose: onCollapseLeft,
              children: jsx160(ExplorerPanel, {
                readOnlyStudio
              })
            }) : jsx160(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: jsx160(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? jsx160(SplitterHandle, {
                ...
                children: [
                  jsx160(SplitterElement, {
                    ...
                    children: jsx160("div", {
                      ...
                      children: size4 ? jsx160(CanvasOrLoading, {
                        size: size4
                      }) : null
                    })
                  }),
                  actualStateRight === "expanded" ? jsx160(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? jsx160(MobilePanel, {
                    onClose: onCollapseRight,
                    children: jsx160(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : jsx160(SplitterElement, {
                    sticky: null,
      ...
      jsx160(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      jsx160(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      jsx160(TitleUpdater, {})
    ]
...
var SidebarCollapserControls = () => {
  ...
  const leftIcon = useCallback80((color) => {
    return {
      width: "35%",
      height: "100%",
  ...
  const rightIcon = useCallback80((color) => {
    return {
      width: "35%",
      height: "100%",
      right: 0,
  ...
  const toggleLeft = useCallback80(() => {
    setSidebarCollapsedState({
      left: (s) => {
        if (s === "responsive") {
  ...
  const toggleRight = useCallback80(() => {
    setSidebarCollapsedState({
      right: (s) => s === "collapsed" ? "expanded" : "collapsed",
      left: null
    });
  }, [setSidebarCollapsedState]);
  const toggleBoth = useCallback80(() => {
  ...
  useEffect52(() => {
    ...
    const right2 = keybindings2.registerKeybinding({
      event: "keydown",
      key: "j",
      commandCtrlKey: true,
    ...
    const zen = keybindings2.registerKeybinding({
      event: "keydown",
      key: "g",
      commandCtrlKey: true,
      callback: toggleBoth,
  ...
  }, [keybindings2, toggleBoth, toggleLeft, toggleRight]);
  ...
  const colorStyle = useCallback80((color) => {
    return {
      ...style9,
      color
    };
  }, []);
  const toggleLeftAction = useCallback80((color) => {
    return jsx161("div", {
  ...
  const toggleRightAction = useCallback80((color) => {
    return jsx161("div", {
      style: colorStyle(color),
...
var UpdateCheck = () => {
  const [info, setInfo] = useState52(null);
  const { setSelectedModal } = useContext51(ModalsContext);
  const { tabIndex } = useZIndex();
  const [knownBugs, setKnownBugs] = useState52(null);
  const hasKnownBugs = useMemo87(() => {
    return knownBugs && knownBugs.length > 0;
  }, [knownBugs]);
  const checkForUpdates = useCallback81(() => {
  ...
  const checkForBugs = useCallback81(() => {
    const controller = new AbortController;
  ...
  const dynButtonStyle = useMemo87(() => {
    return {
      ...buttonStyle4,
...
var MenuToolbar = ({ readOnlyStudio }) => {
  const [selected, setSelected] = useState53(null);
  const mobileLayout = useMobileLayout();
  const fixedWidthRight = useMemo88(() => {
    return {
  ...
  const fixedWidthLeft = useMemo88(() => {
    return {
  ...
  const itemClicked = useCallback82((itemId) => {
    setSelected(itemId);
  }, [setSelected]);
  const itemHovered = useCallback82((itemId) => {
    if (selected) {
      setSelected(itemId);
    }
  }, [selected, setSelected]);
  const closeMenu = useCallback82(() => {
    setSelected(null);
  }, []);
  const structure = useMenuStructure(closeMenu, readOnlyStudio);
  const menus = useMemo88(() => {
    return structure.map((s) => s.id);
  }, [structure]);
  const onPreviousMenu = useCallback82(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onNextMenu = useCallback82(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onItemQuit = useCallback82(() => {
    setSelected(null);
  }, [setSelected]);
  return jsxs77(Row, {
    align: "center",
    ...
    children: [
      jsxs77("div", {
        ...
        children: [
          ...
          readOnlyStudio ? null : jsx163(UpdateCheck, {})
        ]
      }),
      jsx163("div", {
        style: flex2
      }),
      jsx163(MenuBuildIndicator, {}),
      jsx163("div", {
        style: flex2
      }),
      jsx163("div", {
        style: fixedWidthRight,
        children: jsx163(SidebarCollapserControls, {})
      }),
      jsx163(Spacing, {
        x: 1
      })
...
import {useContext as useContext60, useMemo as useMemo99} from "react";
...
import {Internals as Internals40, useVideoConfig as useVideoConfig4} from "remotion";
...
var TimelineInOutPointer = () => {
  ...
  return jsxs79(Fragment24, {
    children: [
      inFrame !== null && jsx164("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
...
import {createRef as createRef10, useContext as useContext53, useMemo as useMemo89} from "react";
...
var TimelineInOutPointerHandle = ({
  ...
  return jsx165(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
var TimelineDragHandler = () => {
  const video2 = Internals40.useUnsafeVideoConfig();
  const { zoom: zoomMap } = useContext54(TimelineZoomCtx);
  const { canvasContent } = useContext54(Internals40.CompositionManager);
  const containerStyle2 = useMemo90(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return {};
    }
    const zoom = zoomMap[canvasContent.compositionId] ?? TIMELINE_MIN_ZOOM;
  ...
  return jsx166("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video2 ? jsx166(Inner2, {}) : null
  });
};
var Inner2 = () => {
  const videoConfig = useVideoConfig4();
  const size4 = PlayerInternals14.useElementSize(scrollableRef, {
    triggerOnWindowResize: true,
    shouldApplyCssTransforms: true
  });
  const { isHighestContext } = useZIndex();
  ...
  const get = useCallback83((frame2) => {
    if (timelineWidth === null) {
  ...
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
  const { setInAndOutFrames } = useTimelineSetInOutFramePosition();
  const [dragging, setDragging] = useState54({
    dragging: false
  });
  const { playing, play: play2, pause: pause2, seek } = PlayerInternals14.usePlayer();
  const scroller = useRef28(null);
  const stopInterval = () => {
    if (scroller.current) {
  ...
  const onPointerDown = useCallback83((e) => {
    if (e.button !== 0) {
      return;
    }
    if (!isHighestContext) {
  ...
  const onPointerMoveScrubbing = useCallback83((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerMoveInOut = useCallback83((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpScrubbing = useCallback83((e) => {
    stopInterval();
    if (!videoConfig) {
      return;
    }
    ...
    setFrame((c) => {
      ...
      Internals40.persistCurrentFrame(newObj);
      return newObj;
    });
    if (dragging.wasPlaying) {
      play2();
    }
  }, [dragging, left3, play2, videoConfig, setFrame, width]);
  const onPointerUpInOut = useCallback83((e) => {
    if (!videoConfig) {
      return;
    }
    if (!inOutDragging.dragging) {
  ...
  const outContextMenu = useMemo90(() => {
    return [
      {
        id: "hide-out",
        keyHint: null,
  ...
  return jsxs80("div", {
    ...
    children: [
      ...
      inFrame !== null && jsx166(ContextMenu, {
        values: inContextMenu,
        children: jsx166(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && jsx166(ContextMenu, {
...
import {useCallback as useCallback86, useContext as useContext56, useMemo as useMemo92} from "react";
...
var TimelineLayerEye = ({ onInvoked, hidden, type }) => {
  const renderAction = useCallback84((color) => {
    if (hidden) {
      return null;
    }
    if (type === "speaker") {
  ...
  const onPointerDown = useCallback84((e) => {
    if (e.button !== 0) {
      return;
    }
...
var TimelineStack = ({ isCompact, sequence }) => {
  const [originalLocation, setOriginalLocation] = useState55(null);
  const [stackHovered, setStackHovered] = useState55(false);
  const [titleHovered, setTitleHovered] = useState55(false);
  const [opening, setOpening] = useState55(false);
  const selectAsset = useSelectAsset();
  const connectionStatus = useContext55(StudioServerConnectionCtx).previewServerState.type;
  const assetPath = useMemo91(() => {
  ...
  const navigateToAsset = useCallback85((asset) => {
    selectAsset(asset);
    pushUrl(`/assets/${asset}`);
  }, [selectAsset]);
  const openEditor = useCallback85(async (location2) => {
  ...
  const onClickTitle = useCallback85(() => {
    if (!titleHoverable) {
      return null;
    }
    if (assetPath) {
  ...
  const onClickStack = useCallback85(() => {
    if (!originalLocation) {
      return;
    }
    if (canOpenInEditor) {
  ...
  const onStackPointerEnter = useCallback85(() => {
    setStackHovered(true);
  }, []);
  const onStackPointerLeave = useCallback85(() => {
    setStackHovered(false);
  }, []);
  const onTitlePointerEnter = useCallback85(() => {
    setTitleHovered(true);
  }, []);
  const onTitlePointerLeave = useCallback85(() => {
    setTitleHovered(false);
  }, []);
  const style11 = useMemo91(() => {
    return {
      fontSize: 12,
  ...
  return jsxs81(Fragment25, {
    children: [
      ...
      isCompact || !originalLocation ? null : jsx168("div", {
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  const { hidden, setHidden } = useContext56(Internals41.SequenceVisibilityToggleContext);
  const padder = useMemo92(() => {
    return {
      width: Number(SPACING * 1.5) * nestedDepth,
      flexShrink: 0
    };
  }, [nestedDepth]);
  const isItemHidden = useMemo92(() => {
    return hidden[sequence.id] ?? false;
  }, [hidden, sequence.id]);
  const onToggleVisibility = useCallback86((type) => {
    setHidden((prev) => {
      return {
        ...prev,
  ...
  return jsxs82("div", {
    ...
    children: [
      ...
      sequence.parent && nestedDepth > 0 ? jsx169("div", {
        style: space
      }) : null,
      jsx169(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
import {useContext as useContext57, useEffect as useEffect56, useMemo as useMemo93, useRef as useRef29} from "react";
...
var TimelineTimeIndicators = () => {
  ...
  const video2 = Internals42.useVideo();
  if (sliderTrack === null) {
    return null;
  }
  if (video2 === null) {
  ...
  return jsx170(Inner3, {
    durationInFrames: video2.durationInFrames,
    fps: video2.fps,
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return jsx170("div", {
    ...
    children: ticks.map((t) => {
      return jsx170("div", {
        style: t.style,
        children: t.showTime ? jsx170("div", {
          style: tickLabel,
...
var TimelineList = ({ timeline: timeline2 }) => {
  const ref = useRef30(null);
  const size4 = PlayerInternals15.useElementSize(ref, {
    shouldApplyCssTransforms: false,
    triggerOnWindowResize: false
  });
  ...
  return jsxs83("div", {
    ...
    style: container34,
    children: [
      jsx171(TimelineTimePadding, {}),
      timeline2.map((track) => {
        return jsx171("div", {
          children: jsx171(TimelineListItem, {
...
import {useContext as useContext58, useEffect as useEffect57} from "react";
...
var TimelinePlayCursorSyncer = () => {
  ...
  const timelineContext = useContext58(Internals43.Timeline.TimelineContext);
  const timelinePosition = Internals43.Timeline.useTimelinePosition();
  const { canvasContent } = useContext58(Internals43.CompositionManager);
  ...
  if (zoom && video2) {
    ...
    setCurrentZoom(zoom);
    setCurrentDuration(video2.durationInFrames);
...
var TimelineScrollable = ({ children }) => {
  const containerStyle2 = useMemo94(() => {
    return {
      width: "100%",
      minHeight: "100%"
    };
...
import {useMemo as useMemo98} from "react";

// src/components/Timeline/TimelineSequence.tsx
import {useContext as useContext59, useMemo as useMemo97, useState as useState58} from "react";
import {Internals as Internals45, useCurrentFrame as useCurrentFrame3} from "remotion";
...
var getTimelineSequenceLayout = ({
  ...
  const lastFrame = (video2.durationInFrames ?? 1) - 1;
  ...
  const premountWidth = premountDisplay ? Math.floor(getWidthOfTrack({
...
import {useEffect as useEffect58, useMemo as useMemo96, useRef as useRef31, useState as useState56} from "react";
import {Internals as Internals44} from "remotion";

// src/components/AudioWaveformBar.tsx
import {useMemo as useMemo95} from "react";
import {
jsx as jsx173
} from "react/jsx-runtime";
...
var AudioWaveform = ({
  ...
  const vidConf = Internals44.useUnsafeVideoConfig();
  if (vidConf === null) {
  ...
  useEffect58(() => {
    ...
    const context5 = canvas.current.getContext("2d");
    if (!context5) {
      return;
    }
    context5.clearRect(0, 0, visualizationWidth, TIMELINE_LAYER_HEIGHT);
    if (!doesVolumeChange || typeof volume === "number") {
      return;
    }
    const volumes = volume.split(",").map((v) => Number(v));
    context5.beginPath();
    context5.moveTo(0, TIMELINE_LAYER_HEIGHT);
  ...
  return jsxs84("div", {
    ...
    children: [
      normalized.map((w) => {
        return jsx174(AudioWaveformBar, {
...
var LoopedTimelineIndicator = ({ loops }) => {
  return jsx176(AbsoluteFill2, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return jsxs86(React124.Fragment, {
        children: [
          jsx176(Flex, {}),
          i === loops - 1 ? null : jsx176(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
import {useEffect as useEffect59, useRef as useRef32, useState as useState57} from "react";
import {
jsx as jsx178
} from "react/jsx-runtime";
var containerStyle2 = {
...
var TimelineSequence = ({ s }) => {
  const windowWidth = useContext59(TimelineWidthContext);
  if (windowWidth === null) {
    return null;
  }
  return jsx179(Inner4, {
    windowWidth,
    s
  });
};
var Inner4 = ({ s, windowWidth }) => {
  ...
  const { marginLeft, width: width2, premountWidth } = useMemo97(() => {
  ...
  }, [maxMediaDuration, s, video2, windowWidth]);
  const style11 = useMemo97(() => {
    return {
  ...
  return jsxs87("div", {
    ...
    children: [
      ...
      s.type === "audio" ? jsx179(AudioWaveform, {
        src: s.src,
      ...
      s.type === "video" ? jsx179(TimelineVideoInfo, {
        src: s.src
      }) : null,
      s.loopDisplay === undefined ? null : jsx179(LoopedTimelineIndicator, {
        loops: s.loopDisplay.numberOfTimes
      }),
      s.type !== "audio" && s.type !== "video" && s.loopDisplay === undefined && (isInRange || isPremounting) ? jsx179("div", {
        style: {
        ...
        children: jsx179(TimelineSequenceFrame, {
...
var TimelineTracks = ({ timeline: timeline2, hasBeenCut }) => {
  const inner2 = useMemo98(() => {
    return {
      height: TIMELINE_LAYER_HEIGHT,
      marginBottom: TIMELINE_ITEM_BORDER_BOTTOM
    };
  }, []);
  const timelineStyle = useMemo98(() => {
    return {
      ...timelineContent,
      width: 100 + "%"
    };
  ...
  return jsxs88("div", {
    ...
    children: [
      jsxs88("div", {
        ...
        children: [
          ...
          timeline2.map((track) => {
            ...
            return jsx180("div", {
              style: inner2,
              children: jsx180(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? jsx180(MaxTimelineTracksReached, {}) : null
    ]
  });
};
...
var Timeline = () => {
  const { sequences } = useContext60(Internals46.SequenceManager);
  const videoConfig = Internals46.useUnsafeVideoConfig();
  const timeline2 = useMemo99(() => {
    if (!videoConfig) {
      return [];
    }
  ...
  const filtered = useMemo99(() => {
    const withoutHidden = timeline2.filter((t) => !isTrackHidden(t));
  ...
  return jsx181("div", {
    ...
    children: jsx181(TimelineWidthProvider, {
      children: jsx181("div", {
        style: inner2,
        children: jsxs89(SplitterContainer, {
          orientation: "vertical",
          defaultFlex: 0.2,
          ...
          minFlex: 0.15,
          children: [
            jsx181(SplitterElement, {
              type: "flexer",
              sticky: jsx181(TimelineTimePlaceholders, {}),
              children: jsx181(TimelineList, {
                timeline: shown
              })
            }),
            jsx181(SplitterHandle, {
              onCollapse: noop6,
            ...
            jsx181(SplitterElement, {
              type: "anti-flexer",
              sticky: null,
              children: jsxs89(TimelineScrollable, {
                children: [
                  jsx181(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  jsx181(TimelineInOutPointer, {}),
                  jsx181(TimelinePlayCursorSyncer, {}),
                  jsx181(TimelineDragHandler, {}),
                  jsx181(TimelineTimeIndicators, {}),
                  jsx181(TimelineSlider, {})
                ]
              })
            })
          ]
...
var EditorContent = ({
  ...
  const isStill = useIsStill();
  const { canvasContent } = useContext61(Internals47.CompositionManager);
  const onlyTopPanel = canvasContent === null || isStill || canvasContent.type !== "composition";
  return jsxs90("div", {
    style: container38,
    children: [
      jsx182(InitialCompositionLoader2, {}),
      jsx182(MenuToolbar, {
        readOnlyStudio
      }),
      onlyTopPanel ? jsx182("div", {
        style: containerColumn,
        children: jsx182(TopPanel, {
          size: size4,
          drawRef,
          bufferStateDelayInMilliseconds,
          onMounted,
...
import {useContext as useContext62, useEffect as useEffect60} from "react";
var GlobalKeybindings = () => {
  ...
  useEffect60(() => {
    ...
    const cmdKKey = keybindings2.registerKeybinding({
      event: "keydown",
      key: "k",
      callback: () => {
        setSelectedModal({
    ...
    const cKey = keybindings2.registerKeybinding({
      event: "keypress",
      key: "t",
      callback: () => {
        setCheckerboard((c) => !c);
    ...
    const questionMark = keybindings2.registerKeybinding({
      event: "keypress",
      key: "?",
      callback: () => {
        setSelectedModal({
  ...
  }, [keybindings2, setCheckerboard, setSelectedModal]);
  return null;
};

// src/components/Modals.tsx
import {useContext as useContext74} from "react";

// src/components/NewComposition/DeleteComposition.tsx
import {useCallback as useCallback90, useContext as useContext67, useMemo as useMemo101} from "react";

// src/components/ModalHeader.tsx
import {useCallback as useCallback87, useContext as useContext63} from "react";
import {
jsx as jsx183,
jsxs as jsxs91
} from "react/jsx-runtime";
...
import React131, {useContext as useContext64, useEffect as useEffect61, useMemo as useMemo100} from "react";
...
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  const resolved = Internals48.useResolvedVideoConfig(compositionId);
  const unresolvedContext = useContext64(Internals48.CompositionManager);
  const unresolved = unresolvedContext.compositions.find((c) => compositionId === c.id);
  useEffect61(() => {
    const { current } = Internals48.resolveCompositionsRef;
    if (!current) {
  ...
  return jsx184(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
import {useCallback as useCallback88, useContext as useContext65, useEffect as useEffect62, useState as useState59} from "react";
...
var CodemodFooter = ({
  ...
  const [codemodStatus, setCanApplyCodemod] = useState59({
    type: "loading"
  });
  ...
  const getCanApplyCodemod = useCallback88(async (signal) => {
...
import {useCallback as useCallback89, useContext as useContext66} from "react";
...
var DismissableModal = ({ children }) => {
  ...
  const onQuit = useCallback89(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  return jsx188(ModalContainer, {
...
var DeleteCompositionLoaded = ({ compositionId }) => {
  const context5 = useContext67(ResolvedCompositionContext);
  if (!context5) {
    throw new Error("Resolved composition context");
  }
  const { unresolved } = context5;
  const codemod = useMemo101(() => {
    return {
      type: "delete-composition",
      idToDelete: compositionId
    };
  }, [compositionId]);
  const onSubmit = useCallback90((e) => {
    e.preventDefault();
  }, []);
  return jsxs95(Fragment26, {
    children: [
      jsx189(NewCompHeader, {
...
var DeleteComposition = ({ compositionId }) => {
  return jsx189(DismissableModal, {
    children: jsx189(ResolveCompositionBeforeModal, {
      compositionId,
      children: jsx189(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
import {useCallback as useCallback92, useContext as useContext68, useMemo as useMemo102, useState as useState60} from "react";
...
import {useCallback as useCallback91} from "react";
import {
jsx as jsx190,
jsxs as jsxs96,
...
var NewCompDuration = ({ durationInFrames, setDurationInFrames }) => {
  const onDurationInFramesChanged = useCallback91((newValue) => {
    setDurationInFrames(Number(newValue));
  }, [setDurationInFrames]);
  const onDurationChangedDirectly = useCallback91((newVal) => {
    ...
    children: [
      ...
      jsxs96("div", {
        ...
        children: [
          ...
          compDurationErrMessage ? jsxs96(Fragment27, {
            children: [
              jsx190(Spacing, {
                y: 1,
                block: true
              }),
              jsx190(ValidationMessage, {
                align: "flex-start",
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const { resolved, unresolved } = context5;
  const [initialCompType] = useState60(initialType);
  ...
  const { compositions } = useContext68(Internals50.CompositionManager);
  ...
  const [size4, setSize] = useState60(() => ({
    width: resolved.result.width,
    height: resolved.result.height
  }));
  const [durationInFrames, setDurationInFrames] = useState60(resolved.result.durationInFrames);
  const onTypeChanged = useCallback92((newType) => {
    setType(newType);
  }, []);
  const onWidthChanged = useCallback92((newValue) => {
    setSize((s) => {
      const { height } = s;
  ...
  const onWidthDirectlyChanged = useCallback92((newWidth) => {
    setSize((s) => {
      const { height } = s;
      return {
        height,
  ...
  const onHeightDirectlyChanged = useCallback92((newHeight) => {
    setSize((s) => {
  ...
  const onHeightChanged = useCallback92((newValue) => {
    setSize((s) => {
      const { width: width2 } = s;
  ...
  const onNameChange = useCallback92((e) => {
    setName(e.target.value);
  }, []);
  const onTextFpsChange = useCallback92((newFps) => {
    setFrameRate(Number(newFps));
  }, []);
  const onFpsChange = useCallback92((newFps) => {
    setFrameRate(newFps);
  }, []);
  ...
  const onSubmit = useCallback92((e) => {
    e.preventDefault();
  }, []);
  return jsxs97(Fragment28, {
    children: [
      jsx191(NewCompHeader, {
      ...
      jsxs97("form", {
        ...
        children: [
          jsxs97("div", {
            style: content3,
            children: [
              initialCompType === "composition" ? jsxs97("div", {
                style: optionRow,
                children: [
                  jsx191("div", {
                    style: label5,
                  ...
                  jsx191("div", {
                    ...
                    children: jsxs97("div", {
                      children: [
                        ...
                        compNameErrMessage ? jsxs97(Fragment28, {
                          children: [
                            jsx191(Spacing, {
                              y: 1,
                              block: true
                            }),
                            jsx191(ValidationMessage, {
                              align: "flex-start",
              ...
              hadDimensionsDefined ? jsxs97(Fragment28, {
                children: [
                  jsxs97("div", {
                    style: optionRow,
                    children: [
                      ...
                      jsxs97("div", {
                        ...
                        children: [
                          ...
                          compWidthErrMessage ? jsxs97(Fragment28, {
                            children: [
                              jsx191(Spacing, {
                                y: 1,
                                block: true
                    ...
                    children: [
                      ...
                      jsxs97("div", {
                        ...
                        children: [
                          ...
                          compHeightErrMessage ? jsxs97(Fragment28, {
                            children: [
                              jsx191(Spacing, {
                                y: 1,
                                block: true
              ...
              type === "composition" && hadDurationDefined ? jsx191(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? jsxs97("div", {
                style: optionRow,
                children: [
                  jsx191("div", {
                    style: label5,
          ...
          jsx191("div", {
            style: { ...content3, borderTop: "1px solid black" },
            children: jsx191(CodemodFooter, {
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return jsx191(DismissableModal, {
    children: jsx191(ResolveCompositionBeforeModal, {
      compositionId,
      children: jsx191(DuplicateCompositionLoaded, {
...
import {useCallback as useCallback93, useContext as useContext69, useMemo as useMemo103, useState as useState61} from "react";
...
var RenameCompositionLoaded = () => {
  ...
  const { compositions } = useContext69(Internals51.CompositionManager);
  const [newId, setName] = useState61(() => {
    return resolved.result.id;
  });
  const onNameChange = useCallback93((e) => {
    setName(e.target.value);
  }, []);
  ...
  return jsxs98(Fragment29, {
    children: [
      jsx192(NewCompHeader, {
      ...
      jsxs98("form", {
        ...
        children: [
                ...
                jsx192("div", {
                  ...
                  children: jsxs98("div", {
                    children: [
                      ...
                      compNameErrMessage ? jsxs98(Fragment29, {
                        children: [
                          jsx192(Spacing, {
                            y: 1,
                            block: true
                          }),
                          jsx192(ValidationMessage, {
                            align: "flex-start",
                            message: compNameErrMessage,
                            type: "error"
                          })
          ...
          jsx192("div", {
            style: { ...content4, borderTop: "1px solid black" },
            children: jsx192(CodemodFooter, {
...
var RenameComposition = ({ compositionId }) => {
  return jsx192(DismissableModal, {
    children: jsx192(ResolveCompositionBeforeModal, {
      compositionId,
      children: jsx192(RenameCompositionLoaded, {})
    })
  });
};
...
var KeyboardShortcutsExplainer = () => {
  return jsxs99("div", {
    children: [
      areKeyboardShortcutsDisabled() ? jsxs99("div", {
...
import {useEffect as useEffect63, useMemo as useMemo104, useRef as useRef33, useState as useState62} from "react";
import {
jsx as jsx196,
jsxs as jsxs101,
...
var QuickSwitcherResult = ({ result, selected }) => {
  ...
  return jsxs101("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? jsx196(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : jsx196(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
      ...
      jsx196("div", {
        ...
        children: result.type === "search-result" ? jsxs101(Fragment30, {
          children: [
            jsx196("div", {
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  const { compositions } = useContext70(Internals52.CompositionManager);
  ...
  const selectComposition = useSelectComposition();
  const closeMenu = useCallback94(() => {
    return;
  }, []);
  const actions9 = useMenuStructure(closeMenu, readOnlyStudio);
  const [docResults, setDocResults] = useState63({ type: "initial" });
  const { setSelectedModal } = useContext70(ModalsContext);
  const keybindings2 = useKeybinding();
  const mode = mapQueryToMode(state.query);
  const actualQuery = useMemo105(() => {
    return stripQuery(state.query);
  }, [state.query]);
  const menuActions = useMemo105(() => {
    if (mode !== "commands") {
      return [];
    }
    return makeSearchResults(actions9, setSelectedModal);
  }, [actions9, mode, setSelectedModal]);
  const resultsArray = useMemo105(() => {
    if (mode === "commands") {
  ...
  const onArrowDown = useCallback94(() => {
    setState((s) => {
      return {
        ...s,
  ...
  }, [keybindings2, onArrowDown]);
  const onTextChange = useCallback94((e) => {
  ...
  const onActionsSelected = useCallback94(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback94(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback94(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container43 = useMemo105(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo105(() => {
    ...
    children: [
      ...
      jsxs102("div", {
        ...
        children: [
          ...
          showKeyboardShortcuts ? jsxs102(Fragment31, {
            children: [
              jsx197(Spacing, {
                x: 2
              }),
              " ",
              jsx197(AlgoliaCredit, {})
            ]
          }) : null
        ]
      }),
      jsx197("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? jsx197(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? jsx197(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return jsx197(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return jsx198(DismissableModal, {
    children: jsx198(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import {useMemo as useMemo106, useState as useState64} from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState64("general");
  const shownTabs = useMemo106(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => jsx199("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
  children: jsx199("path", {
    fill: "currentcolor",
...
var PicIcon = (props) => jsx201("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
  children: jsx201("path", {
    fill: "currentcolor",
...
var GearIcon = (props) => jsx202("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
  children: jsx202("path", {
    fill: "currentcolor",
...
var GifIcon = (props) => jsx203("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
  children: jsx203("path", {
    fill: "currentcolor",
...
import {useCallback as useCallback95, useMemo as useMemo107, useState as useState65} from "react";
import {
jsx as jsx204
} from "react/jsx-runtime";
var selectorButton2 = {
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const onPointerLeave = useCallback95(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo107(() => {
    return {
      ...selectorButton2,
...
import {useCallback as useCallback96, useEffect as useEffect65, useMemo as useMemo108, useState as useState66} from "react";
import {
jsx as jsx205
} from "react/jsx-runtime";
var svgStyle3 = {
...
var CliCopyButton = ({
  ...
  const fillColor = useMemo108(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = jsx205(ClipboardIcon, {
    color: fillColor,
    style: svgStyle3
  });
  const checkSvg = jsx205("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle3,
    children: jsx205("path", {
      fill: fillColor,
      d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
    })
  });
  const onPointerEnter = useCallback96(() => {
    setHovered(true);
  }, []);
        ...
        children: [
          jsxs103("div", {
            ...
            children: [
              ...
              jsx206("div", {
                style: copyWrapper,
                children: jsx206(CliCopyButton, {
                  valueToCopy: option.cliFlag
                })
              })
            ]
          }),
          option.ssrName ? jsxs103("div", {
            style: infoRow,
            children: [
              jsx206("div", {
                style: infoRowLabel,
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return jsx207(InfoBubble, {
    title: "Learn more about this option",
    children: jsx207(OptionExplainer, {
      option
    })
  });
};
...
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  const onTextChanged = useCallback97((e) => {
    onValueChanged((q) => {
  ...
  const onValueChange = useCallback97((newConcurrency) => {
  ...
  return jsxs104("div", {
    ...
    children: [
      jsxs104("div", {
        ...
        children: [
          name,
          hint ? jsxs104(Fragment32, {
            children: [
              jsx208(Spacing, {
                x: 0.5
              }),
              jsx208(OptionExplainerBubble, {
                id: hint
              })
            ]
          }) : null
      ...
      jsx208("div", {
        style: rightRow,
        children: jsx208(RightAlignInput, {
          children: jsx208(InputDragger, {
            value,
...
var useCrfState = (codec) => {
  const [state, setState] = useState67(() => getDefaultCrfState());
...
import {useCallback as useCallback101, useMemo as useMemo109} from "react";
...
import React142, {useCallback as useCallback99} from "react";

// src/components/RenderModal/InlineEyeIcon.tsx
import {useCallback as useCallback98} from "react";
import {
jsx as jsx210
} from "react/jsx-runtime";
var clearIcon2 = {
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback98((color) => {
    return enabled ? jsx210("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
      children: jsx210("path", {
        fill: color,
...
var EnvInput = ({
  ...
  const [showInPlainText, setShowInPlainText] = React142.useState(false);
  const [initialWarningKeyMissing, setKeyWarningEligible] = React142.useState(() => {
    return envKey.trim() === "" && envVal.trim() !== "";
  });
  const [initialWarningValMissing, setValueWarningEligible] = React142.useState(() => {
    return envKey.trim() !== "" && envVal.trim() === "";
  });
  ...
  const handleDelete = useCallback99(() => {
    onDelete(index);
  }, [index, onDelete]);
  const togglePlainText = useCallback99(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback99((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback99((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback99(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback99(() => {
    setValueWarningEligible(true);
  }, []);
  const isNodeEnvKey = envKey.trim() === "NODE_ENV";
  return jsxs105(Fragment33, {
    children: [
      jsxs105(Row, {
        align: "center",
        style: optionRow,
        children: [
          jsx211(RemotionInput, {
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback100((index, value) => {
  ...
  const onEnvKeyChange = useCallback100((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback100((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback100(() => {
...
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo109(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const onVerboseLoggingChanged = useCallback101((e) => {
    setVerboseLogging(e.target.checked ? "verbose" : "info");
  }, [setVerboseLogging]);
  const toggleCustomOffthreadVideoCacheSizeInBytes = useCallback101(() => {
  ...
  const toggleCustomUserAgent = useCallback101(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback101((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback101((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback101((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback101((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback101((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback101((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback101((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback101((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo109(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? jsx214(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo109(() => {
  ...
  const changeOffthreadVideoCacheSizeInBytes = useCallback101((cb) => {
  ...
  return jsxs107("div", {
    ...
    children: [
      ...
      renderMode === "still" ? null : jsx214(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
      ...
      renderMode === "video" && codec === "h264" ? jsxs107("div", {
        style: optionRow,
        children: [
          jsxs107("div", {
            style: label5,
      ...
      renderMode === "audio" ? null : jsxs107("div", {
        style: optionRow,
        children: [
          jsx214("div", {
            style: label5,
      ...
      renderMode === "audio" || offthreadVideoCacheSizeInBytes === null ? null : jsx214(NumberSetting, {
        min: minConcurrency,
        max: 2097152000,
        step: 1024,
      ...
      userAgent === null ? null : jsxs107("div", {
        style: optionRow,
        children: [
          jsx214("div", {
            style: label5,
      ...
      jsx214(RenderModalHr, {}),
      jsx214(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
import {useCallback as useCallback105} from "react";
...
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback102((e) => {
...
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback103((e) => {
...
import {useCallback as useCallback104, useMemo as useMemo110} from "react";

// src/helpers/use-file-existence.ts
import {useContext as useContext71, useEffect as useEffect66, useRef as useRef35, useState as useState68} from "react";
...
var RenderModalOutputName = ({
  ...
  return jsxs110("div", {
    ...
    children: [
      ...
      jsx217("div", {
        style: rightRow,
        children: jsxs110("div", {
          children: [
            jsx217(RemotionInput, {
            ...
            validationMessage ? jsxs110(Fragment34, {
              children: [
                jsx217(Spacing, {
                  y: 1,
                  block: true
                }),
                jsx217(ValidationMessage, {
                  align: "flex-end",
                  message: validationMessage,
                  type: "error"
                })
              ]
            }) : existence ? jsxs110(Fragment34, {
              children: [
                jsx217(Spacing, {
                  y: 1,
                  block: true
...
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const onValueChange = useCallback104((e) => {
    setSeparateAudioTo(e.target.value);
  }, [setSeparateAudioTo]);
  const validationMessage = useMemo110(() => {
  ...
  return jsx218(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback104((e) => {
    if (e.target.checked) {
  ...
  return jsxs111(Fragment35, {
    children: [
      ...
      separateAudioTo === null ? null : jsx218(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback105((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback105((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback105((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback105((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? jsx219(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  return jsxs112("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "video" ? jsxs112(Fragment36, {
        children: [
          jsx219(MutedSetting, {
            enforceAudioTrack,
            muted,
          ...
          jsx219(RenderModalHr, {})
        ]
      }) : null,
      renderMode === "video" && audioCodecOptions(codec).length >= 2 && !muted ? jsxs112("div", {
        style: optionRow,
        children: [
          jsxs112("div", {
            style: label5,
      ...
      (renderMode === "video" || renderMode === "audio") && !muted && jsxs112(Fragment36, {
        children: [
          jsx219(EnforceAudioTrackSetting, {
            muted,
            enforceAudioTrack,
      ...
      renderMode === "video" && !muted ? jsx219(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
      }) : null,
      audioCodec === "aac" && !muted ? jsxs112("div", {
        style: optionRow,
        children: [
          jsxs112("div", {
            style: label5,
      ...
      renderMode === "still" || muted ? null : jsxs112("div", {
        style: optionRow,
        children: [
          jsxs112("div", {
            style: label5,
      ...
      shouldHaveCustomTargetAudioBitrate && renderMode !== "still" && !muted ? jsxs112("div", {
        style: optionRow,
        children: [
          jsx219("div", {
            style: label5,
...
import {useCallback as useCallback108, useMemo as useMemo112} from "react";
...
import {useCallback as useCallback106, useMemo as useMemo111} from "react";
import {
jsx as jsx220,
jsxs as jsxs113
} from "react/jsx-runtime";
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback106((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo111(() => {
  ...
  const onChangeLeft = useCallback106((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback106((event) => {
...
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback107((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback107((newEndFrame) => {
...
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo112(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? jsx222(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo112(() => {
  ...
  const onFrameSetDirectly = useCallback108((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback108((e) => {
    setFrame((q) => {
  ...
  const onValueChange = useCallback108((e) => {
    setOutName(e.target.value);
  }, [setOutName]);
  return jsxs115("div", {
    style: container48,
    children: [
      renderMode === "still" || renderMode === "sequence" ? jsxs115("div", {
        style: optionRow,
        children: [
          jsx222("div", {
            style: label5,
          ...
          jsx222("div", {
            style: rightRow,
            children: jsx222(SegmentedControl, {
      ...
      renderMode === "still" && resolvedComposition.durationInFrames > 1 ? jsxs115("div", {
        style: optionRow,
        children: [
          jsx222("div", {
            style: label5,
          ...
          jsx222("div", {
            style: rightRow,
            children: jsx222(RightAlignInput, {
              children: jsx222(InputDragger, {
                value: frame2,
      ...
      renderMode === "video" && codec === "prores" ? jsxs115("div", {
        style: optionRow,
        children: [
          jsx222("div", {
            style: label5,
      ...
      renderMode === "still" ? null : jsx222(FrameRangeSetting, {
...
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback109((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback109((e) => {
  ...
  return jsxs116("div", {
    ...
    children: [
      ...
      jsx223("div", {
        style: rightRow,
        children: jsx223(RightAlignInput, {
          children: jsx223(InputDragger, {
...
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback110((e) => {
    setLimitNumberOfGifLoops(e.target.checked);
  }, [setLimitNumberOfGifLoops]);
  return jsxs117("div", {
    style: container49,
    children: [
      jsx224(NumberSetting, {
      ...
      limitNumberOfGifLoops ? jsx224(NumberOfLoopsSetting, {
...
import {useCallback as useCallback111, useMemo as useMemo113} from "react";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo113(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? jsx227(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo113(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback111((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback111((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback111((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback111((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback111((e) => {
    ...
    children: [
      renderMode === "video" ? jsxs118("div", {
        ...
        children: [
          ...
          jsx227("div", {
            style: rightRow,
            children: jsx227(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && jsx227(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && jsx227(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? jsx227(RenderModalHr, {}) : null,
      shouldDisplayQualityControlPicker && renderMode === "video" ? jsxs118("div", {
        style: optionRow,
        children: [
          jsx227("div", {
            style: label5,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" ? jsx227(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? jsxs118("div", {
        style: optionRow,
        children: [
          jsxs118("div", {
            style: label5,
      ...
      renderMode === "video" ? jsxs118(Fragment37, {
        children: [
          jsxs118("div", {
            style: optionRow,
            children: [
          ...
          encodingBufferSize === null ? null : jsxs118("div", {
            style: optionRow,
            children: [
              jsx227("div", {
                style: label5,
          ...
          encodingMaxRate === null ? null : jsxs118("div", {
            style: optionRow,
            children: [
              jsx227("div", {
                style: label5,
      ...
      renderMode === "video" ? jsx227(RenderModalHr, {}) : null,
      jsx227(ScaleSetting, {
        scale,
        setScale
      }),
...
var RenderModal = ({
  ...
  const context5 = useContext72(ResolvedCompositionContext);
  if (!context5) {
  ...
  const isMounted = useRef36(true);
  const [isVideo] = useState69(() => {
  ...
  const [unclampedFrame, setFrame] = useState69(() => initialFrame);
  const [saving, setSaving] = useState69(false);
  const [stillImageFormat, setStillImageFormat] = useState69(() => initialStillImageFormat);
  const [videoImageFormat, setVideoImageFormat] = useState69(() => initialVideoImageFormat);
  const [sequenceImageFormat, setSequenceImageFormat] = useState69(() => initialStillImageFormat === "jpeg" ? "jpeg" : "png");
  const [concurrency, setConcurrency] = useState69(() => initialConcurrency);
  const [videoCodecForVideoTab, setVideoCodecForVideoTab] = useState69(() => initialVideoCodecForVideoTab);
  const [userSelectedAudioCodec, setUserSelectedAudioCodec] = useState69(() => initialAudioCodec);
  const [separateAudioTo, setSeparateAudioTo] = useState69(null);
  const [envVariables, setEnvVariables] = useState69(() => envVariablesObjectToArray(initialEnvVariables).filter(([key5]) => key5 !== "NODE_ENV"));
  const [initialOutName] = useState69(() => {
  ...
  const [videoCodecForAudioTab, setVideoCodecForAudioTab] = useState69(() => initialVideoCodecForAudioTab);
  const [mutedState, setMuted] = useState69(() => initialMuted);
  const [repro, setRepro] = useState69(() => initialRepro);
  const [enforceAudioTrackState, setEnforceAudioTrackState] = useState69(() => initialEnforceAudioTrack);
  const [forSeamlessAacConcatenation, setForSeamlessAacConcatenation] = useState69(() => initialForSeamlessAacConcatenation);
  const [renderMode, setRenderModeState] = useState69(initialRenderType);
  const [jpegQuality, setJpegQuality] = useState69(() => initialJpegQuality);
  const [scale, setScale] = useState69(() => initialScale);
  const [logLevel, setLogLevel] = useState69(() => initialLogLevel);
  const [disallowParallelEncoding, setDisallowParallelEncoding] = useState69(false);
  const [disableWebSecurity, setDisableWebSecurity] = useState69(() => initialDisableWebSecurity);
  const [headless, setHeadless] = useState69(() => initialHeadless);
  const [beepOnFinish, setBeepOnFinish] = useState69(() => initialBeep);
  const [ignoreCertificateErrors, setIgnoreCertificateErrors] = useState69(() => initialIgnoreCertificateErrors);
  const [multiProcessOnLinux, setChromiumMultiProcessOnLinux] = useState69(() => initialMultiProcessOnLinux);
  const [openGlOption, setOpenGlOption] = useState69(() => initialGl ?? "default");
  const [colorSpace, setColorSpace] = useState69(() => initialColorSpace);
  const [userAgent, setUserAgent] = useState69(() => initialUserAgent === null ? null : initialUserAgent.trim() === "" ? null : initialUserAgent);
  const chromiumOptions = useMemo114(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const [outName, setOutName] = useState69(() => initialOutName);
  const [endFrameOrNull, setEndFrame] = useState69(() => outFrameMark ?? null);
  const [startFrameOrNull, setStartFrame] = useState69(() => inFrameMark ?? null);
  const [proResProfileSetting, setProResProfile] = useState69(() => initialProResProfile);
  const [x264PresetSetting, setx264Preset] = useState69(() => initialx264Preset);
  const [userPreferredPixelFormat, setPixelFormat] = useState69(() => initialPixelFormat);
  const [preferredQualityControlType, setQualityControl] = useState69(() => initialVideoBitrate === null ? "crf" : "bitrate");
  const [
    shouldHaveCustomTargetAudioBitrate,
    setShouldHaveCustomTargetAudioBitrate
  ] = useState69(() => initialAudioBitrate !== null);
  const [customTargetAudioBitrate, setCustomTargetAudioBitrateValue] = useState69(() => initialAudioBitrate ?? "320K");
  const [customTargetVideoBitrate, setCustomTargetVideoBitrateValue] = useState69(() => initialVideoBitrate ?? "1M");
  const [encodingMaxRate, setEncodingMaxRate] = useState69(() => initialEncodingMaxRate ?? null);
  const [encodingBufferSize, setEncodingBufferSize] = useState69(() => initialEncodingBufferSize ?? null);
  const [limitNumberOfGifLoops, setLimitNumberOfGifLoops] = useState69(() => initialNumberOfGifLoops !== null);
  const [numberOfGifLoopsSetting, setNumberOfGifLoopsSetting] = useState69(() => initialNumberOfGifLoops ?? 0);
  const [delayRenderTimeout, setDelayRenderTimeout] = useState69(() => initialDelayRenderTimeout);
  const [offthreadVideoCacheSizeInBytes, setOffthreadVideoCacheSizeInBytes] = useState69(initialOffthreadVideoCacheSizeInBytes);
  const codec = useMemo114(() => {
    if (renderMode === "audio") {
      return videoCodecForAudioTab;
    }
    return videoCodecForVideoTab;
  }, [videoCodecForAudioTab, renderMode, videoCodecForVideoTab]);
  const numberOfGifLoops = useMemo114(() => {
    if (codec === "gif" && limitNumberOfGifLoops) {
      return numberOfGifLoopsSetting;
    }
    return null;
  }, [codec, limitNumberOfGifLoops, numberOfGifLoopsSetting]);
  const audioBitrate = useMemo114(() => {
  ...
  const supportsBothQualityControls = useMemo114(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo114(() => {
  ...
  const dispatchIfMounted = useCallback112((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo114(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo114(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback112((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback112((options) => {
  ...
  const setAudioCodec = useCallback112((newAudioCodec) => {
  ...
  const setCodec = useCallback112((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback112((format) => {
    setStillImageFormat(format);
    setDefaultOutName({ type: "still", imageFormat: format });
  }, [setDefaultOutName]);
  const { setSidebarCollapsedState } = useContext72(SidebarContext);
  const onClickStill = useCallback112(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
  ...
  const [everyNthFrameSetting, setEveryNthFrameSetting] = useState69(() => initialEveryNthFrame);
  const everyNthFrame = useMemo114(() => {
    if (codec === "gif") {
  ...
  const availablePixelFormats = useMemo114(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo114(() => {
  ...
  const onClickVideo = useCallback112(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const onClickSequence = useCallback112(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo114(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback112((newRenderMode) => {
  ...
  const renderTabOptions = useMemo114(() => {
  ...
  const pixelFormatOptions = useMemo114(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? jsx228(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return jsxs119("div", {
    style: outer4,
    children: [
      jsx228(NewCompHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      jsxs119("div", {
        style: container51,
        children: [
          jsx228(SegmentedControl, {
      ...
      jsxs119("div", {
        ...
        children: [
          jsxs119("div", {
            style: leftSidebar,
            children: [
              shownTabs.includes("general") ? jsxs119(VerticalTab, {
                style: horizontalTab,
              ...
              shownTabs.includes("data") ? jsxs119(VerticalTab, {
                style: horizontalTab,
                selected: tab === "data",
                onClick: () => setTab("data"),
                children: [
              ...
              shownTabs.includes("picture") ? jsxs119(VerticalTab, {
                style: horizontalTab,
              ...
              shownTabs.includes("audio") ? jsxs119(VerticalTab, {
                style: horizontalTab,
                selected: tab === "audio",
              ...
              shownTabs.includes("gif") ? jsxs119(VerticalTab, {
                style: horizontalTab,
                selected: tab === "gif",
                onClick: () => setTab("gif"),
                children: [
              ...
              shownTabs.includes("advanced") ? jsxs119(VerticalTab, {
                style: horizontalTab,
          ...
          jsx228("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? jsx228(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame3,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? jsx228(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? jsx228(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
...
var RenderModalWithLoader = (props) => {
  return jsx228(DismissableModal, {
    children: jsx228(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: jsx228(RenderModal, {
        ...props
      })
    })
  });
...
import {useCallback as useCallback114, useContext as useContext73} from "react";

// src/components/RenderModal/GuiRenderStatus.tsx
import {useCallback as useCallback113, useMemo as useMemo115} from "react";
...
var BundlingProgress = ({ progress, doneIn }) => {
  return jsxs120("div", {
    style: progressItem,
    children: [
      progress === 1 ? jsx230(SuccessIcon, {}) : jsx230(CircularProgress, {
        progress
      }),
      jsx230(Spacing, {
        x: 1
...
var RenderingProgress = ({ progress }) => {
  return jsxs120("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? jsx230(SuccessIcon, {}) : jsx230(CircularProgress, {
...
var OpenFile = ({ job }) => {
  ...
  return jsxs120("div", {
    ...
    children: [
      ...
      jsx230("div", {
        style: right3,
        children: jsx230(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return jsxs120("div", {
    children: [
      ...
      jsx230(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? jsx230(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? jsx230(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? jsx230(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? jsx230(OpenFile, {
        job
      }) : null,
      jsx230(Spacing, {
        y: 1
...
var RenderStatusModal = ({ jobId }) => {
  ...
  const { jobs } = useContext73(RenderQueueContext);
  ...
  const onRetry = useCallback114(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback114(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback114(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
  ...
  return jsxs121(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children: [
      jsx231(NewCompHeader, {
        title: `Render ${job.compositionId}`
      }),
      jsxs121("div", {
        style: container52,
        children: [
          job.status === "failed" ? jsxs121(Fragment38, {
            children: [
              jsx231("p", {
          ...
          job.status === "done" || job.status === "running" ? jsx231(GuiRenderStatus, {
            job
          }) : null,
          jsx231("div", {
            style: spacer3
          ...
          jsxs121("div", {
            style: buttonRow,
            children: [
              job.status === "running" ? jsx231(Button, {
              ...
              jsx231(Flex, {}),
              job.status === "failed" ? jsx231(Button, {
                onClick: onRetry,
                children: "Retry"
              }) : null,
              jsx231("div", {
...
import {useCallback as useCallback117, useMemo as useMemo117} from "react";

// src/components/CopyButton.tsx
import {useCallback as useCallback115, useEffect as useEffect68, useState as useState70} from "react";
import {
jsx as jsx232,
jsxs as jsxs122
} from "react/jsx-runtime";
...
import {useCallback as useCallback116, useMemo as useMemo116, useState as useState71} from "react";
import {
jsx as jsx233
} from "react/jsx-runtime";
var svgStyle4 = {
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback116(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo116(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = jsx233("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle4,
    children: jsx233("path", {
      fill: svgFillColor,
      d: "M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
    })
  });
  const onPointerEnter = useCallback116(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback116(() => {
    setHovered(false);
  }, []);
  return jsx233("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
...
var UpdateModal = ({ info, knownBugs }) => {
  const hasKnownBugs = useMemo117(() => {
    return knownBugs && knownBugs?.length > 0;
  }, [knownBugs]);
  const command = commands[info.packageManager];
  const onClick = useCallback117(() => {
    copyText(command).catch((err) => {
      showNotification(`Could not copy: ${err.message}`, 2000);
    });
  }, [command]);
  return jsxs124(DismissableModal, {
    children: [
      jsx235(NewCompHeader, {
        title: "Update available"
      }),
      jsxs124("div", {
        style: container54,
        children: [
          hasKnownBugs ? jsxs124(Fragment39, {
            children: [
              jsxs124("div", {
                style: title7,
                children: [
...
var Modals = ({ readOnlyStudio }) => {
  const { selectedModal: modalContextType } = useContext74(ModalsContext);
  const canRender = useContext74(StudioServerConnectionCtx).previewServerState.type === "connected";
  return jsxs125(Fragment40, {
    children: [
      modalContextType && modalContextType.type === "duplicate-comp" && jsx236(DuplicateComposition, {
        compositionType: modalContextType.compositionType,
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "delete-comp" && jsx236(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && jsx236(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && jsx236(RenderModalWithLoader, {
      ...
      modalContextType && canRender && modalContextType.type === "render-progress" && jsx236(RenderStatusModal, {
        jobId: modalContextType.jobId
      }),
      modalContextType && modalContextType.type === "update" && jsx236(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "quick-switcher" && jsx236(QuickSwitcher_default, {
        readOnlyStudio,
...
var BUFFER_STATE_DELAY_IN_MILLISECONDS = typeof process.env.BUFFER_STATE_DELAY_IN_MILLISECONDS === "undefined" ? DEFAULT_BUFFER_STATE_DELAY_IN_MILLISECONDS : Number(process.env.BUFFER_STATE_DELAY_IN_MILLISECONDS);
var Editor = ({ Root, readOnlyStudio }) => {
  const drawRef = useRef37(null);
  const size4 = PlayerInternals16.useElementSize(drawRef, {
    triggerOnWindowResize: false,
    shouldApplyCssTransforms: true
  });
  useEffect69(() => {
  ...
  const [canvasMounted, setCanvasMounted] = React161.useState(false);
  const onMounted = useCallback118(() => {
    setCanvasMounted(true);
  }, []);
  const value = useMemo118(() => {
    if (!size4) {
      return null;
    }
    return {
  ...
  const MemoRoot = useMemo118(() => {
    return React161.memo(Root);
  }, [Root]);
  return jsx237(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: jsxs126(TimelineZoomContext, {
      children: [
        jsx237(Internals53.CurrentScaleContext.Provider, {
          value,
          children: jsxs126("div", {
            style: background2,
            children: [
              canvasMounted ? jsx237(MemoRoot, {}) : null,
              jsxs126(Internals53.CanUseRemotionHooksProvider, {
                children: [
                  jsx237(EditorContent, {
                    drawRef,
                    size: size4,
                    onMounted,
                    readOnlyStudio,
...
import {useCallback as useCallback119, useContext as useContext75, useMemo as useMemo119, useState as useState72} from "react";
...
var PreviewSizeProvider = ({ children }) => {
  const [size4, setSizeState] = useState72(() => loadPreviewSizeOption());
  const [translation, setTranslation] = useState72(() => {
    return {
      x: 0,
      y: 0
    };
  ...
  const setSize = useCallback119((newValue) => {
  ...
  const previewSizeCtx = useMemo119(() => {
    return {
  ...
  return jsx238(Internals54.PreviewSizeContext.Provider, {
...
import {useCallback as useCallback120, useMemo as useMemo120, useState as useState73} from "react";
import {
jsx as jsx239
} from "react/jsx-runtime";
var CheckerboardProvider = ({ children }) => {
  const [checkerboard6, setCheckerboardState] = useState73(() => loadCheckerboardOption());
  const setCheckerboard = useCallback120((newValue) => {
  ...
  const checkerboardCtx = useMemo120(() => {
    return {
      checkerboard: checkerboard6,
      setCheckerboard
    };
  }, [checkerboard6, setCheckerboard]);
  return jsx239(CheckerboardContext.Provider, {
...
import {useMemo as useMemo121, useState as useState74} from "react";
import {Internals as Internals55} from "remotion";
import {
jsx as jsx240
} from "react/jsx-runtime";
var MediaVolumeProvider = ({ children }) => {
  const [mediaMuted, setMediaMuted] = useState74(() => loadMuteOption());
  const [mediaVolume, setMediaVolume] = useState74(1);
  const mediaVolumeContextValue = useMemo121(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo121(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
  }, []);
  return jsx240(Internals55.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: jsx240(Internals55.SetMediaVolumeContext.Provider, {
...
import {useMemo as useMemo122, useState as useState75} from "react";
import {
jsx as jsx241
} from "react/jsx-runtime";
var ModalsProvider = ({ children }) => {
  const [modalContextType, setModalContextType] = useState75(null);
  const modalsContext = useMemo122(() => {
    return {
      selectedModal: modalContextType,
      setSelectedModal: setModalContextType
    };
  }, [modalContextType]);
  return jsx241(ModalsContext.Provider, {
    value: modalsContext,
    children
  });
};
...
import {useEffect as useEffect70, useMemo as useMemo123, useState as useState76} from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  const [inAndOutFrames, setInAndOutFrames] = useState76(() => loadMarks());
  const setTimelineInOutContextValue = useMemo123(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return jsx242(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: jsx242(SetTimelineInOutContext.Provider, {
...
import {useCallback as useCallback121, useMemo as useMemo124, useRef as useRef38, useState as useState77} from "react";
import {
jsx as jsx243
} from "react/jsx-runtime";
var ShowGuidesProvider = ({ children }) => {
  const [guidesList, setGuidesList] = useState77(() => loadGuidesList());
  const [selectedGuideId, setSelectedGuideId] = useState77(null);
  const [hoveredGuideId, setHoveredGuideId] = useState77(null);
  const [editorShowGuides, setEditorShowGuidesState] = useState77(() => loadEditorShowGuidesOption());
  const shouldCreateGuideRef = useRef38(false);
  const shouldDeleteGuideRef = useRef38(false);
  const setEditorShowGuides = useCallback121((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo124(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return jsx243(EditorShowGuidesContext.Provider, {
...
import {useCallback as useCallback122, useMemo as useMemo125, useState as useState78} from "react";
import {
jsx as jsx244
} from "react/jsx-runtime";
var ShowRulersProvider = ({ children }) => {
  const [editorShowRulers, setEditorShowRulersState] = useState78(() => loadEditorShowRulersOption());
  const setEditorShowRulers = useCallback122((newValue) => {
  ...
  const editorShowRulersCtx = useMemo125(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return jsx244(EditorShowRulersContext.Provider, {
...
import {useCallback as useCallback123, useMemo as useMemo126, useState as useState79} from "react";
import {
jsx as jsx245
} from "react/jsx-runtime";
var ZoomGesturesProvider = ({ children }) => {
  const [editorZoomGestures, setEditorZoomGesturesState] = useState79(() => loadEditorZoomGesturesOption());
  const setEditorZoomGestures = useCallback123((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo126(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return jsx245(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return jsx246(ZodProvider, {
    children: jsx246(PreviewServerConnection, {
      readOnlyStudio,
      children: jsx246(RenderQueueContextProvider, {
        children: jsx246(KeybindingContextProvider, {
          children: jsx246(CheckerboardProvider, {
            children: jsx246(ZoomGesturesProvider, {
              children: jsx246(ShowRulersProvider, {
                children: jsx246(ShowGuidesProvider, {
                  children: jsx246(PreviewSizeProvider, {
                    children: jsx246(ModalsProvider, {
                      children: jsx246(MediaVolumeProvider, {
                        children: jsx246(PlayerInternals17.PlayerEmitterProvider, {
                          currentPlaybackRate: null,
                          children: jsx246(SidebarContextProvider, {
                            children: jsx246(FolderContextProvider, {
                              children: jsx246(HighestZIndexProvider, {
                                children: jsx246(SetTimelineInOutProvider, {
                                  children
                                })
                              })
                            })
...
var ServerDisconnected = () => {
  const { previewServerState: ctx } = useContext76(StudioServerConnectionCtx);
  ...
  return jsx247("div", {
    ...
    children: jsxs127("div", {
      ...
      children: [
        ...
        jsx247("br", {}),
        window.remotion_studioServerCommand ? jsxs127("span", {
          children: [
            "Run",
            " ",
            jsx247("code", {
...
var injectCSS = () => {
  ...
  Internals56.CSSUtils.injectCSS(makeDefaultGlobalCSS());
  injected = true;
};
...
var Studio = ({ rootComponent, readOnly }) => {
  useLayoutEffect2(() => {
    ...
    Internals57.enableSequenceStackTraces();
  }, []);
  useLayoutEffect2(() => {
    injectCSS();
  }, []);
  return jsx248(Internals57.RemotionRoot, {
    numberOfAudioTags: window.remotion_numberOfAudioTags,
    children: jsxs128(EditorContexts, {
      ...
      children: [
        ...
        readOnly ? null : createPortal(jsx248(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
